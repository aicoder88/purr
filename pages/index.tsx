...
import {
  UrgencyBanner,
  StickyUrgencyBar,
} from "../src/components/sections/urgency-banner";
        ...
        additionalMetaTags={[
          {
            name: "keywords",
            content:
              "cat litter odor control, activated carbon cat litter, natural cat litter additive, eco-friendly pet odor control, cat litter deodorizer, pet odor elimination, cat care products, natural odor control, cat litter solution, pet supplies Canada",
          },
          {
            name: "robots",
            content:
          ...
          },
          {
            name: "description",
            content:
              "Purrify is a premium activated carbon cat litter additive that eliminates odors at the molecular level. Made from natural coconut shell carbon, it provides 7-day freshness and works with any litter type. Trusted by thousands of cat owners across Canada.",
          },
