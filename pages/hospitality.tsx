...
export default function Hospitality() {
  ...
  const content = {
    en: {
      ...
      statReviews: 'Better Reviews',
      statReviewsDesc: 'Fresh-smelling properties get higher ratings',
  ...
  const canonicalUrl = `https://www.purrify.ca/${locale === 'en' ? '' : locale + '/'}hospitality`;
  ...
  const structuredData = {
    ...
    "mainEntity": {
      ...
      "offers": {
        ...
        "eligibility": "Vacation rentals, Airbnb hosts, property managers, hotels",
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-gradient-to-r from-amber-50 to-orange-50 dark:from-amber-900/20 dark:to-orange-900/20 border border-amber-200 dark:border-amber-800 rounded-lg p-6 mb-8">
              <div className="grid md:grid-cols-3 gap-6 text-center">
                ...
                <div>
                  <div className="flex items-center justify-center gap-1 text-3xl font-bold text-amber-600 dark:text-amber-400 mb-2">
