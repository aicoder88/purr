  ...
  try {
    ...
    if (
      ...
      const foundPost = sampleBlogPosts.find((post) => {
        ...
        const postSlug = post.link
          .replace(/^\/(en|fr|zh)\//, "")
          .replace(/^\//, "");
        return (
          postSlug === `blog/${params.slug}` ||
          postSlug.endsWith(`/${params.slug}`)
        );
      });
    ...
    const response = await fetch(
      `${wpApiUrl}/posts?slug=${params.slug}&_embed`,
    );
        ...
        <Container>
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mt-12 pt-8 border-t border-[#E0EFC7]">
              <h3 className="text-xl font-bold mb-4 text-[#5B2EFF]">
                Share this article
              </h3>
