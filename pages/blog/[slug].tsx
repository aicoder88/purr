            ...
            <div className="mt-12 pt-8 border-t border-[#E0EFC7]">
              ...
              <div className="flex space-x-4">
                <a
                  ...
                  className="bg-[#1DA1F2] text-white dark:text-white p-3 rounded-full hover:bg-[#1DA1F2]/80 transition-colors"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="bg-[#1877F2] text-white dark:text-white p-3 rounded-full hover:bg-[#1877F2]/80 transition-colors"
                >
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="bg-[#0A66C2] text-white dark:text-white p-3 rounded-full hover:bg-[#0A66C2]/80 transition-colors"
                >
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
