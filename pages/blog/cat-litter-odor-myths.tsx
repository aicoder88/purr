...
const heroImage = '/optimized/90day-science.jpg';
                    ...
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="prose prose-lg max-w-none dark:prose-invert prose-headings:font-heading prose-headings:text-[#5B2EFF] dark:prose-headings:text-[#3694FF]">
                            ...
                            <figure className="my-8">
                                <Image src="/optimized/ph-scale-ammonia-ghibli.png" alt="pH Scale showing Baking Soda (Alkaline) vs Ammonia (Alkaline) - they don't react" width={800} height={450} className="w-full md:w-3/4 mx-auto rounded-xl shadow-lg" />
                            ...
                            <figure className="my-8">
                                <Image src="/optimized/coffee-vs-carbon-ghibli.png" alt="Comparison: Messy coffee grounds vs clean activated carbon granules" width={800} height={450} className="w-full md:w-3/4 mx-auto rounded-xl shadow-lg" />
