  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content={`Terms of Service for ${SITE_NAME}. ${SITE_DESCRIPTION}`}
        />
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg max-w-none text-gray-700">
              <p>
                ...
                carefully before using the https://purrify.ca website (the
                "Service") operated by {SITE_NAME} ("us", "we", or "our").
              </p>
              <p>
              ...
              <p>
                ...
                exclusive property of {SITE_NAME} and its licensors. The Service
                is protected by copyright, trademark, and other laws of both
                Canada and foreign countries. Our trademarks and trade dress may
                not be used in connection with any product or service without
                the prior written consent of {SITE_NAME}.
              </p>

              <h2>6. Links To Other Web Sites</h2>
              <p>
                Our Service may contain links to third-party web sites or
                services that are not owned or controlled by {SITE_NAME}.
              </p>
              <p>
                {SITE_NAME} has no control over, and assumes no responsibility
                for, the content, privacy policies, or practices of any third
                party web sites or services. You further acknowledge and agree
                that {SITE_NAME} shall not be responsible or liable, directly or
              ...
              <p>
                In no event shall {SITE_NAME}, nor its directors, employees,
              ...
              <p>
                {SITE_NAME}, its subsidiaries, affiliates, and its licensors do
              ...
              <p>
                ...
                the laws of Quebec, Canada, without regard to its conflict of
                law provisions.
              </p>
              <p>
