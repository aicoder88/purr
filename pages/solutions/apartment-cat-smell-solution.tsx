...
export default function apartmentcatsmellsolutionPage() {
  ...
  const seoDescription = 'Effective solution for apartment cat smell solution. Purrify eliminates odors completely, perfect for apartment living. Works with any litter brand.';
    ...
    <>
      <NextSeo
        ...
        additionalMetaTags={[
          {
            name: 'keywords',
            content: 'apartment cat smell solution, cat odor control, activated carbon, natural solution',
          },
        ]}
      />
        ...
        <section className="py-20 px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-700 dark:text-gray-300 mb-8">
              Complete solution for apartment cat smell solution
            </p>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg p-8 shadow-xl max-w-2xl mx-auto">
              ...
              <p className="text-lg mb-6">Purrify eliminates odors completely, perfect for apartment living</p>
