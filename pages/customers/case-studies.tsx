...
const CaseStudiesPage: NextPage = () => {
  ...
  const caseStudies = [
    {
      ...
      quote:
        "I was skeptical at first, but Purrify completely transformed my small apartment. The difference was noticeable within hours, and now I can't imagine life without it.",
      image: "/optimized/testimonial-sarah.webp",
      beforeAfter: {
        before:
          "Daily complaints from neighbors, frequent litter changes, expensive odor sprays",
    ...
    },
    {
      ...
      quote:
        "With three cats, our house used to smell terrible despite constant cleaning. Purrify gave us our home back. It's been a game-changer for our entire family.",
      image: "/optimized/testimonial-mike.webp",
      beforeAfter: {
        before:
          "Multiple litter boxes, daily cleaning, overwhelming odors, social isolation",
        after:
          "Single litter box, weekly maintenance, odor-free home, active social life",
      },
    ...
    },
    {
      ...
      quote:
        "When my 16-year-old cat developed kidney issues, the odors became overwhelming. Purrify helped us maintain a clean, comfortable environment during his treatment.",
      image: "/optimized/testimonial-emma.webp",
      beforeAfter: {
        before:
          "Constant odors affecting quality of life, difficult health monitoring",
    ...
    },
    {
      ...
      quote:
        "Our kids' allergies were getting worse, and we thought we might have to rehome our cats. Purrify let us keep our family together while creating a healthier home.",
  ...
  return (
    <>
      <Head>
        <title>
          Customer Case Studies - Real Purrify Success Stories | Purrify
        </title>
        <meta
          name="description"
        ...
        <link
          rel="canonical"
          href={`https://purrify.com${locale === "fr" ? "/fr" : ""}/customers/case-studies`}
        />

        {/* Open Graph */}
        <meta
          property="og:title"
          content="Customer Case Studies - Real Purrify Success Stories"
        />
        <meta
          property="og:description"
          content="Discover how Purrify transformed real customers' lives with detailed case studies showing before and after results."
        />
        <meta property="og:type" content="article" />
        <meta
          property="og:url"
          content={`https://purrify.com${locale === "fr" ? "/fr" : ""}/customers/case-studies`}
        />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              description:
                "Detailed case studies of how Purrify activated carbon litter additive transformed customers' lives.",
              author: {
                "@type": "Organization",
                name: "Purrify",
              },
          ...
          <Container>
            <div className="text-center text-white max-w-4xl mx-auto">
              ...
              <p className="text-xl md:text-2xl mb-8 opacity-90">
                Detailed success stories showing how Purrify transformed real
                households
              </p>
          ...
          <Container>
            <div className="text-center max-w-2xl mx-auto">
              ...
              <p className="text-xl text-gray-600 dark:text-gray-300 mb-8">
                Have you experienced amazing results with Purrify? We'd love to
                feature your success story and help other cat owners discover
                the difference.
              </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              >
                <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg border border-[#E0EFC7] dark:border-gray-700 hover:shadow-xl transition-shadow">
                  ...
                  <p className="text-gray-600 dark:text-gray-300">
                    Read quick reviews and ratings from verified customers
                    across Canada.
                  </p>
                </div>
              </Link>
              ...
              >
                <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg border border-[#E0EFC7] dark:border-gray-700 hover:shadow-xl transition-shadow">
                  ...
                  <p className="text-gray-600 dark:text-gray-300">
                    Understand the science behind these amazing results and why
                    Purrify is so effective.
                  </p>
                </div>
              </Link>
              ...
              >
                <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg border border-[#E0EFC7] dark:border-gray-700 hover:shadow-xl transition-shadow">
                  ...
                  <p className="text-gray-600 dark:text-gray-300">
                    Contact our team for personalized recommendations based on
