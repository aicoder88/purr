...
const ProductComparePage: NextPage = () => {
  ...
  return (
    <>
      <Head>
        <title>
          Compare Purrify Products - Find the Perfect Size for Your Needs |
          Purrify
        </title>
        <meta
          name="description"
        ...
        <meta
          name="keywords"
          content="Purrify comparison, cat litter additive sizes, trial size, bulk savings, multi-cat, product comparison"
        />
        <link
          rel="canonical"
          href={`https://purrify.com${locale === "fr" ? "/fr" : ""}/products/compare`}
        />

        {/* Open Graph */}
        <meta
          property="og:title"
          content="Compare Purrify Products - Find the Perfect Size"
        />
        <meta
          property="og:description"
          content="Compare all Purrify sizes and find the perfect activated carbon litter additive for your household needs."
        />
        <meta property="og:type" content="website" />
        <meta
          property="og:url"
          content={`https://purrify.com${locale === "fr" ? "/fr" : ""}/products/compare`}
        />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              description:
                "Compare all Purrify activated carbon litter additive sizes and find the perfect option for your household.",
          ...
          <Container>
            <div className="text-center text-white max-w-4xl mx-auto">
              ...
              <p className="text-xl md:text-2xl mb-8 opacity-90">
                Find the perfect size for your household - from trial to bulk
                savings
              </p>
            </div>
          </Container>
              ...
              {products.map((product) => (
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    {/* CTA Button */}
                    <Link
                      href={`${locale === "fr" ? "/fr" : ""}${product.ctaLink}`}
                    >
                      <Button
                        size="lg"
                        className={`w-full ${
          ...
          <Container>
            <div className="text-center text-white max-w-3xl mx-auto">
              ...
              <p className="text-xl mb-8 opacity-90">
                Start with our risk-free trial size and experience the Purrify
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              >
                <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg border border-[#E0EFC7] dark:border-gray-700 hover:shadow-xl transition-shadow">
                  ...
                  <p className="text-gray-600 dark:text-gray-300">
                    Discover the science behind our activated carbon technology
              ...
              >
                <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg border border-[#E0EFC7] dark:border-gray-700 hover:shadow-xl transition-shadow">
                  ...
                  <p className="text-gray-600 dark:text-gray-300">
                    See what thousands of satisfied customers are saying about
                    their Purrify experience.
                  </p>
                </div>
              </Link>
              ...
              >
                <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg border border-[#E0EFC7] dark:border-gray-700 hover:shadow-xl transition-shadow">
                  ...
                  <p className="text-gray-600 dark:text-gray-300">
                    Learn about different litter types and how to choose the
