...
const CaseStudiesPage: NextPage = () => {
  const caseStudies = [
    {
      ...
      solution:
        "A commencé avec la taille d'essai 17g, utilise maintenant 60g mensuellement",
      results: [
      ...
      quote:
        "J'étais sceptique au début, mais Purrify a complètement transformé mon petit appartement. La différence était notable en quelques heures, et maintenant je ne peux plus imaginer la vie sans.",
      image: "/optimized/testimonial-sarah.webp",
      beforeAfter: {
        before:
          "Plaintes quotidiennes des voisins, changements fréquents de litière, vaporisateurs d'odeur coûteux",
        after:
          "Appartement sans odeur, litière qui dure 3x plus longtemps, voisins heureux",
      },
    ...
    },
    {
      ...
      quote:
        "Avec trois chats, notre maison sentait terrible malgré le nettoyage constant. Purrify nous a redonné notre maison. C'est un changement révolutionnaire pour toute notre famille.",
      image: "/optimized/testimonial-mike.webp",
      beforeAfter: {
        before:
          "Plusieurs bacs à litière, nettoyage quotidien, odeurs accablantes, isolement social",
        after:
          "Un seul bac à litière, entretien hebdomadaire, maison sans odeur, vie sociale active",
      },
    ...
    },
    {
      ...
      duration: "8 mois",
      challenge:
        "Chat senior avec problèmes de santé causant des odeurs plus fortes",
      solution:
        "Utilisation régulière de la taille 60g avec approbation vétérinaire",
      results: [
      ...
      quote:
        "Quand mon chat de 16 ans a développé des problèmes rénaux, les odeurs sont devenues accablantes. Purrify nous a aidés à maintenir un environnement propre et confortable pendant son traitement.",
      image: "/optimized/testimonial-emma.webp",
      beforeAfter: {
        before:
          "Odeurs constantes affectant la qualité de vie, surveillance de santé difficile",
        after:
          "Environnement propre soutenant la gestion de la santé et le confort",
      },
      productUsed: "Taille Moyenne 60g",
      satisfaction: 5,
    },
    {
      ...
      duration: "2 ans",
      challenge:
        "Allergies des enfants aggravées par la poussière et les odeurs de litière",
      ...
      quote:
        "Les allergies de nos enfants s'aggravaient, et nous pensions devoir reloger nos chats. Purrify nous a permis de garder notre famille ensemble tout en créant une maison plus saine.",
      image: "/optimized/testimonial-johnson.webp",
      beforeAfter: {
        before:
          "Allergies des enfants, produits chimiques agressifs, relogement potentiel des animaux",
        after:
          "Environnement sain, solutions naturelles, famille heureuse avec animaux",
      },
  ...
  return (
    <>
      <Head>
        <title>
          Études de Cas Clients - Vraies Histoires de Succès Purrify | Purrify
        </title>
        <meta
          name="description"
        ...
        <meta
          name="keywords"
          content="études de cas Purrify, histoires de succès clients, résultats avant après, solutions odeur litière chat, témoignages"
        />
        <link
          rel="canonical"
          href="https://purrify.com/fr/customers/case-studies"
        />

        {/* Open Graph */}
        <meta
          property="og:title"
          content="Études de Cas Clients - Vraies Histoires de Succès Purrify"
        />
        <meta
          property="og:description"
          content="Découvrez comment Purrify a transformé la vie de vrais clients avec des études de cas détaillées montrant les résultats avant et après."
        />
        <meta property="og:type" content="article" />
        <meta
          property="og:url"
          content="https://purrify.com/fr/customers/case-studies"
        />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "@type": "Article",
              headline:
                "Études de Cas Clients - Vraies Histoires de Succès Purrify",
              description:
                "Études de cas détaillées de comment l'additif de litière au charbon actif Purrify a transformé la vie des clients.",
              author: {
                "@type": "Organization",
                name: "Purrify",
              },
        ...
        <section className="py-4 border-b border-[#E0EFC7] dark:border-gray-800">
          <Container>
            <nav className="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-400">
              ...
              <span>/</span>
              <Link
                href="/fr/customers/testimonials"
                className="hover:text-[#FF3131] dark:hover:text-[#FF5050] transition-colors"
              >
                Clients
              </Link>
          ...
          <Container>
            <div className="text-center text-white max-w-4xl mx-auto">
              ...
              <p className="text-xl md:text-2xl mb-8 opacity-90">
                Histoires de succès détaillées montrant comment Purrify a
                transformé de vrais foyers
              </p>
                    ...
                    <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-lg border border-[#E0EFC7] dark:border-gray-700">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                        <div className="p-4 bg-red-50 dark:bg-red-900/20 rounded-lg border-l-4 border-red-500">
                          <h5 className="font-bold text-red-700 dark:text-red-400 mb-2">
                            Avant Purrify:
                          </h5>
                        ...
                        <div className="p-4 bg-green-50 dark:bg-green-900/20 rounded-lg border-l-4 border-green-500">
                          <h5 className="font-bold text-green-700 dark:text-green-400 mb-2">
                            Après Purrify:
                          </h5>
                      ...
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <span className="ml-2 font-semibold text-[#5B2EFF]">
                            {study.productUsed}
                          </span>
                        </div>
          ...
          <Container>
            <div className="text-center max-w-2xl mx-auto">
              ...
              <p className="text-xl text-gray-600 dark:text-gray-300 mb-8">
                Avez-vous vécu des résultats incroyables avec Purrify? Nous
                aimerions présenter votre histoire de succès et aider d'autres
                propriétaires de chats à découvrir la différence.
              </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <Link href="/fr/customers/testimonials" className="group">
                <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg border border-[#E0EFC7] dark:border-gray-700 hover:shadow-xl transition-shadow">
                  ...
                  <p className="text-gray-600 dark:text-gray-300">
                    Lisez des avis rapides et des évaluations de clients
                    vérifiés à travers le Canada.
                  </p>
                </div>
              </Link>
              ...
              <Link href="/fr/learn/how-it-works" className="group">
                <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg border border-[#E0EFC7] dark:border-gray-700 hover:shadow-xl transition-shadow">
                  ...
                  <p className="text-gray-600 dark:text-gray-300">
                    Comprenez la science derrière ces résultats incroyables et
                    pourquoi Purrify est si efficace.
                  </p>
                </div>
              </Link>
              ...
              <Link href="/fr/support/contact" className="group">
                <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg border border-[#E0EFC7] dark:border-gray-700 hover:shadow-xl transition-shadow">
                  ...
                  <p className="text-gray-600 dark:text-gray-300">
                    Contactez notre équipe pour des recommandations
                    personnalisées basées sur votre situation spécifique.
                  </p>
                </div>
              </Link>
            </div>
