...
export default function TestimonialsPageFR() {
  ...
  const pageDescription =
    "Lisez de vrais témoignages clients et histoires de succès de propriétaires de chats qui ont expérimenté le pouvoir d'élimination des odeurs de Purrify. Voyez pourquoi des milliers font confiance à Purrify.";
          ...
          <Container>
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-xl md:text-2xl text-gray-600 dark:text-gray-300 mb-12 leading-relaxed">
                Découvrez pourquoi des milliers de propriétaires de chats font
                confiance à Purrify pour éliminer les odeurs de litière. Lisez
                des témoignages authentiques de clients qui ont expérimenté la
                différence.
              </p>
          ...
          <Container>
            <div className="bg-gradient-to-r from-[#5B2EFF] to-[#03E46A] dark:from-[#3694FF] dark:to-[#FF5050] rounded-3xl p-12 text-center text-white">
              ...
              <p className="text-xl mb-8 opacity-90">
                Expérimentez les mêmes résultats d'élimination des odeurs dont
                nos clients raffolent
              </p>
          ...
          <Container>
            <div className="text-center max-w-2xl mx-auto">
              ...
              <p className="text-xl text-gray-600 dark:text-gray-300 mb-8">
                Avez-vous expérimenté de grands résultats avec Purrify? Nous
