    ...
    <>
      <Head>
        ...
        <link
          rel="alternate"
          hrefLang="fr"
          href={`https://purrify.ca/fr${post.link}`}
        />
        <link
          rel="alternate"
          hrefLang="en"
          href={`https://purrify.ca${post.link}`}
        />
      </Head>
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="mt-12 pt-8 border-t border-gray-200">
              ...
              <div className="flex space-x-4">
                <a
                  href={`https://twitter.com/intent/tweet?url=https://purrify.ca${post.link}&text=${encodeURIComponent(post.title)}`}
                  target="_blank"
                ...
                <a
                  href={`https://www.linkedin.com/shareArticle?mini=true&url=https://purrify.ca${post.link}&title=${encodeURIComponent(post.title)}&summary=${encodeURIComponent(post.excerpt)}`}
                  target="_blank"
                  rel="noopener noreferrer"
