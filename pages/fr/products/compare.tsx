...
const ProductComparePage: NextPage = () => {
  ...
  return (
    <>
      <Head>
        <title>
          Comparer les Produits Purrify - Trouvez la Taille Parfaite | Purrify
        </title>
        <meta
          name="description"
        ...
        <meta
          name="keywords"
          content="comparaison Purrify, tailles additif litière chat, taille essai, économies vrac, multi-chat, comparaison produits"
        />
        ...
        <meta
          property="og:title"
          content="Comparer les Produits Purrify - Trouvez la Taille Parfaite"
        />
        <meta
          property="og:description"
          content="Comparez toutes les tailles Purrify et trouvez l'additif de litière au charbon actif parfait pour vos besoins."
        />
        <meta property="og:type" content="website" />
        <meta
          property="og:url"
          content="https://purrify.com/fr/products/compare"
        />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              description:
                "Comparez toutes les tailles d'additif de litière au charbon actif Purrify et trouvez l'option parfaite pour votre foyer.",
          ...
          <Container>
            <div className="text-center text-white max-w-4xl mx-auto">
              ...
              <p className="text-xl md:text-2xl mb-8 opacity-90">
                Trouvez la taille parfaite pour votre foyer - de l'essai aux
                économies en vrac
              </p>
            </div>
          </Container>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              {products.map((product) => (
                ...
                >
                  ...
                  {/* Header */}
                  <div
                    className={`bg-gradient-to-r ${product.color} p-6 text-white`}
                  >
          ...
          <Container>
            <div className="text-center text-white max-w-3xl mx-auto">
              ...
              <p className="text-xl mb-8 opacity-90">
                Commencez avec notre taille d'essai sans risque et découvrez la
                différence Purrify par vous-même.
              </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <Link href="/fr/learn/how-it-works" className="group">
                <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg border border-[#E0EFC7] dark:border-gray-700 hover:shadow-xl transition-shadow">
                  ...
                  <p className="text-gray-600 dark:text-gray-300">
                    Découvrez la science derrière notre technologie au charbon
              ...
              <Link href="/fr/customers/testimonials" className="group">
                <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg border border-[#E0EFC7] dark:border-gray-700 hover:shadow-xl transition-shadow">
                  ...
                  <p className="text-gray-600 dark:text-gray-300">
                    Voyez ce que des milliers de clients satisfaits disent de
                    leur expérience avec Purrify.
                  </p>
                </div>
              </Link>
              ...
              <Link href="/fr/learn/cat-litter-guide" className="group">
                <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg border border-[#E0EFC7] dark:border-gray-700 hover:shadow-xl transition-shadow">
                  ...
                  <p className="text-gray-600 dark:text-gray-300">
                    Apprenez sur les différents types de litière et comment
                    choisir la meilleure option pour votre chat.
                  </p>
                </div>
              </Link>
            </div>
