...
const OurStoryPage: NextPage = () => {
  const milestones = [
    {
      ...
      description:
        "Notre fondatrice, propriétaire de plusieurs chats, luttait contre les odeurs persistantes du bac à litière malgré avoir essayé tous les produits sur le marché.",
      icon: Lightbulb,
    },
    {
      year: "2008-2009",
      ...
      description:
        "Partenariat avec des scientifiques des matériaux pour développer une formule de charbon actif spécialement conçue pour l'élimination des odeurs de litière pour chat.",
      icon: Target,
    },
    {
      year: "2009",
      ...
      description:
        "Création du premier prototype Purrify et test avec des propriétaires de chats locaux. Les résultats ont dépassé toutes les attentes avec 95% de réduction d'odeurs.",
      icon: Zap,
    },
    {
      year: "2022",
      ...
      description:
        "Lancement officiel de Purrify à travers le Canada, aidant des milliers de propriétaires de chats à créer des maisons plus fraîches et propres.",
      icon: Award,
    },
    {
      year: "2023",
      ...
      description:
        "Expansion de la gamme de produits avec plusieurs tailles et début de l'expédition internationale pour servir les propriétaires de chats mondialement.",
      icon: Users,
    },
    {
      year: "2024",
      ...
      description:
        "Lancement d'emballages écologiques et d'expédition neutre en carbone, renforçant notre engagement envers la responsabilité environnementale.",
      icon: Leaf,
    },
  ];
  ...
  const values = [
    {
      ...
      description:
        "Chaque décision que nous prenons considère d'abord la santé et le bonheur des chats et de leurs familles.",
    },
    {
      icon: Shield,
      title: "Sécurité et Qualité",
      description:
        "Tous les produits subissent des tests rigoureux pour s'assurer qu'ils sont sécuritaires pour les animaux, les familles et l'environnement.",
    },
    {
      icon: Leaf,
      title: "Responsabilité Environnementale",
      description:
        "Nous nous engageons à des pratiques durables et à réduire notre empreinte environnementale à chaque étape.",
    },
    {
      icon: Users,
      title: "Succès Client",
      description:
        "Notre succès se mesure par la satisfaction et l'amélioration de la qualité de vie de nos clients et de leurs animaux.",
    },
  ];
  ...
  const stats = [
    {
      ...
      description:
        "Propriétaires de chats à travers le Canada et internationalement",
    },
    {
      number: "98%",
  ...
  return (
    <>
      <Head>
        <title>
          Notre Histoire - La Mission Derrière l'Additif de Litière Purrify |
          Purrify
        </title>
        <meta
          name="description"
        ...
        <meta
          name="keywords"
          content="histoire Purrify, mission entreprise, innovation litière chat, soins animaux, responsabilité environnementale, entreprise canadienne"
        />
        ...
        <meta
          property="og:title"
          content="Notre Histoire - La Mission Derrière Purrify"
        />
        <meta
          property="og:description"
          content="Découvrez l'histoire derrière Purrify et notre mission d'aider les propriétaires de chats à créer des maisons plus fraîches et propres."
        />
        <meta property="og:type" content="website" />
        <meta
          property="og:url"
          content="https://purrify.com/fr/about/our-story"
        />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              name: "Notre Histoire",
              description:
                "L'histoire derrière l'additif de litière pour chat Purrify et notre mission d'aider les propriétaires de chats à créer des maisons plus fraîches et propres.",
              ...
              mainEntity: {
                ...
                name: "Purrify",
                description:
                  "Entreprise canadienne créant des additifs innovants de litière pour chat pour l'élimination d'odeurs",
                foundingDate: "2019",
                founders: [
                  {
                    "@type": "Person",
          ...
          <Container>
            <div className="text-center text-white max-w-4xl mx-auto">
              ...
              <p className="text-xl md:text-2xl mb-8 opacity-90">
                Née de la frustration d'un propriétaire de chat, devenue une
                mission pour aider les familles partout
              </p>
              <p className="text-lg opacity-80 max-w-2xl mx-auto">
                Ce qui a commencé comme la lutte d'une personne contre les
                odeurs persistantes de bac à litière est devenu une histoire de
                succès canadienne, aidant plus de 50 000 propriétaires de chats
                à créer des maisons plus fraîches et propres.
              </p>
            </div>
          </Container>
        </section>
          ...
          <Container>
            <div className="text-center max-w-3xl mx-auto">
              ...
              <p className="text-xl text-gray-600 dark:text-gray-300 mb-8 leading-relaxed">
                Révolutionner l'expérience de propriété de chat en créant des
                produits innovants, sécuritaires et environnementalement
                responsables qui éliminent les odeurs, réduisent les déchets, et
                renforcent le lien entre les chats et leurs familles.
              </p>
              <div className="bg-[#E0EFC7]/30 dark:bg-gray-800/50 rounded-xl p-8">
                <p className="text-lg text-gray-700 dark:text-gray-300 italic">
                  "Nous croyons que chaque chat mérite un environnement propre
                  et confortable, et chaque famille mérite de profiter de sa
                  maison sans compromis. C'est pourquoi nous nous dédions à
                  créer des produits qui fonctionnent mieux, durent plus
                  longtemps, et respectent notre planète."
                </p>
          ...
          <Container>
            <div className="text-center text-white max-w-3xl mx-auto">
              ...
              <p className="text-xl mb-8 opacity-90">
                Devenez partie de la famille Purrify et découvrez la différence
                que la passion, l'innovation et un véritable soin peuvent faire
                dans votre maison.
              </p>
          ...
          <Container>
            <div className="text-center max-w-2xl mx-auto">
              ...
              <p className="text-xl text-gray-600 dark:text-gray-300 mb-8">
                ...
                Partagez votre histoire, posez des questions, ou dites
                simplement bonjour!
              </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <Link href="/fr/learn/how-it-works" className="group">
                <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg border border-[#E0EFC7] dark:border-gray-700 hover:shadow-xl transition-shadow">
                  ...
                  <p className="text-gray-600 dark:text-gray-300">
                    Découvrez la science et l'innovation derrière notre
                    technologie au charbon actif.
                  </p>
                </div>
              </Link>
              ...
              <Link href="/fr/customers/testimonials" className="group">
                <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg border border-[#E0EFC7] dark:border-gray-700 hover:shadow-xl transition-shadow">
                  ...
                  <p className="text-gray-600 dark:text-gray-300">
                    ...
                    ont transformé leurs maisons avec Purrify.
                  </p>
                </div>
              </Link>
              ...
              <Link href="/fr/products/compare" className="group">
                <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg border border-[#E0EFC7] dark:border-gray-700 hover:shadow-xl transition-shadow">
                  ...
                  <p className="text-gray-600 dark:text-gray-300">
                    Comparez nos options de produits et trouvez la taille
                    Purrify idéale pour votre foyer.
                  </p>
                </div>
              </Link>
            </div>
