  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Réclamez votre sac d'essai GRATUIT d'additif de litière pour chat Purrify. Zéro coût. Zéro risque. Zéro odeur de litière."
        />
                ...
                <div>
                  <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight md:text-left leading-tight">
                    ...
                    <div className="block mt-3 mb-6 relative py-4 px-2">
                      ...
                      <div className="border-t-2 border-b-2 border-indigo-200/50 py-3">
                        <span
                          className="text-3xl font-extrabold bg-gradient-to-r from-pink-600 via-indigo-700 to-purple-700 bg-clip-text text-transparent tracking-wide animate-pulse-slow transform transition-all duration-300 hover:scale-105 inline-block"
                          style={{
                            textShadow: "0px 0px 1px rgba(79, 70, 229, 0.2)",
                          }}
                        >
                  ...
                  <div className="mt-4 bg-indigo-50 p-3 rounded-lg border border-indigo-100">
                    <p className="text-indigo-800 font-medium">
                      Offre à durée limitée : Obtenez votre sac d'essai gratuit
                      de notre formule naturelle anti-odeurs pendant que les
                      stocks durent !
                    </p>
                  </div>
                </div>
                ...
                <div>
                  <p className="text-lg text-[#333333] mb-6 leading-relaxed">
                    <strong className="text-red-600 text-xl">
                      ATTENTION PROPRIÉTAIRES DE CHATS QUI EN ONT ASSEZ DE
                      RETENIR LEUR SOUFFLE :
                    </strong>{" "}
                    Et si, dans les prochaines 24 heures, vous pouviez
                    complètement éliminer cette odeur embarrassante de litière
                    qui vous fait grimacer chaque fois que quelqu'un visite
                    votre maison ?
                  </p>
                  <p className="text-lg text-[#333333] mb-6 leading-relaxed">
                    Voici l'offre : Nous sommes tellement convaincus que Purrify
                    transformera votre maison en un sanctuaire frais et sans
                    odeur que nous faisons quelque chose de fou...
                  </p>
                  <p className="text-lg text-[#333333] mb-6 leading-relaxed">
                    Nous offrons des{" "}
                    <strong className="text-red-600">
                      sacs d'essai GRATUITS aux 500 premiers propriétaires de
                      chats
                    </strong>{" "}
                    qui les réclament.
                  </p>
                  <p className="text-lg text-[#333333] leading-relaxed">
                    Pourquoi ferions-nous cela ? Parce qu'une fois que vous
                    aurez expérimenté ce que c'est que de recevoir des invités
                    SANS vous inquiéter de "cette odeur"... une fois que vous
                    ressentirez le soulagement de ne jamais retenir votre
                    souffle lorsque vous passez devant la litière... une fois
                    que vous découvrirez la joie d'une maison vraiment
                    fraîche...
                    <strong className="text-indigo-700">
                      {" "}
                      Vous deviendrez un client Purrify à vie.
                    </strong>
                  </p>
                </div>
              </div>
              ...
              <div className="relative z-10">
                <div className="mb-8">
                  ...
                  <ul className="space-y-2">
                    <li className="flex items-start">
                      ...
                      <span>
                        Sac d'essai à usage unique de notre formule naturelle
                        anti-odeurs
                      </span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-green-600 font-bold mr-2">✓</span>
                      <span>
                        Élimination instantanée des odeurs - fonctionne avec
                        TOUTE litière que vous utilisez actuellement
                      </span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-green-600 font-bold mr-2">✓</span>
                      <span>
                        Instructions complètes pour des résultats de fraîcheur
                        maximale
                      </span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-green-600 font-bold mr-2">✓</span>
                      <span>
                        Pas de frais d'expédition, pas de coûts cachés, pas de
                        piège
                      </span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-green-600 font-bold mr-2">✓</span>
                      <span>
                        Zéro engagement - c'est notre cadeau pour vous
                      </span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-red-50 border border-red-200 rounded-lg p-4 mb-8">
                  <h3 className="text-xl font-bold text-red-600 mb-2">
                    ATTENTION : Cette offre disparaît dans :
                  </h3>
                  <div className="flex justify-center space-x-4 mb-2">
                    <div className="bg-red-600 text-white px-3 py-2 rounded-md font-mono">
                  ...
                  <p className="text-center text-red-800 font-medium">
                    Limité aux 500 premiers propriétaires de chats seulement.
                  </p>
                  <p className="text-center text-red-800 font-medium">
                    Déjà réclamés : {claimedBags} sur 500
                  </p>
                  <p className="text-center font-bold mt-2">
                    Votre sac gratuit vous attend - mais seulement si vous
                    agissez maintenant.
                  </p>
                </div>
                ...
                <div className="mb-8 bg-indigo-50 border border-indigo-100 rounded-lg p-4">
                  <h3 className="text-xl font-bold text-indigo-800 mb-4">
                    Ce que disent nos testeurs bêta :
                  </h3>
                  <div className="space-y-4">
                    <div className="bg-white p-3 rounded-md shadow-sm">
                      <p className="italic">
                        "Je n'arrivais pas à y croire. En quelques HEURES, toute
                        ma maison sentait à nouveau le frais. J'ai même invité
                        ma belle-mère pour la première fois depuis des mois !"
                      </p>
                    ...
                    <div className="bg-white p-3 rounded-md shadow-sm">
                      <p className="italic">
                        "Mon mari pensait que j'avais complètement jeté la
                        litière. L'odeur avait simplement... disparu."
                      </p>
                      <p className="text-right font-medium text-indigo-600">
                        - Lisa K., Mirabel, QC
                      </p>
                ...
                <div className="bg-red-50 border-2 border-red-200 rounded-lg p-6 mb-8">
                  <div className="flex items-center justify-center mb-4">
                    ...
                    <h2 className="text-3xl font-bold text-red-600 text-center">
                      RÉCLAMEZ VOTRE SAC GRATUIT MAINTENANT
                    </h2>
                  </div>
                  <p className="text-center text-red-800 mb-2">
                    <span className="font-bold">⚠️ ATTENTION :</span> En raison
                    de la forte demande, nous ne pouvons pas garantir la
                    disponibilité après l'expiration du minuteur.
                  </p>
                </div>
                <FreeGiveawayForm />
                ...
                <p className="text-xs text-center text-gray-500 mt-6">
                  ...
                  <br />
                  Offre à durée limitée. Un sac gratuit par foyer. Des
                  restrictions d'expédition peuvent s'appliquer. Nous nous
                  réservons le droit de mettre fin à cette promotion à tout
                  moment.
                </p>
              </div>
            </div>
