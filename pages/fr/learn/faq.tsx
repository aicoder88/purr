  ...
  const faqItems = [
    {
      ...
      answer:
        "Purrify est un additif au charbon actif pour litière qui élimine les odeurs au niveau moléculaire. Le charbon actif possède des millions de pores microscopiques qui piègent et neutralisent les composés responsables des odeurs.",
      popular: true,
    ...
    },
    {
      ...
      answer:
        "Oui, Purrify est complètement sécuritaire. Notre charbon actif est de qualité alimentaire et non-toxique. Il a été testé extensivement et est fait de matériaux naturels.",
      popular: true,
    ...
    },
    {
      ...
      answer:
        "Pour des résultats optimaux, utilisez environ 1-2 cuillères à soupe de Purrify par bac à litière standard. Mélangez-le bien avec votre litière existante lors d'un changement complet.",
      popular: true,
    ...
    },
    {
      ...
      answer:
        "Oui ! Purrify est conçu pour fonctionner avec tout type de litière - argile, agglomérante, cristal, naturelle ou biodégradable.",
      popular: true,
    ...
    },
    {
      ...
      answer:
        "Purrify prolonge la vie de votre litière de 2-3 fois. Au lieu de changer la litière chaque semaine, vous pouvez généralement aller 2-3 semaines avec la même litière.",
      popular: false,
    ...
    },
    {
      ...
      answer:
        "Nous offrons l'expédition standard gratuite (5-7 jours ouvrables) sur les commandes de plus de 25$. L'expédition express (2-3 jours) est disponible pour 9,99$.",
      popular: true,
    ...
    },
    {
      ...
      answer:
        "Nous offrons trois tailles : Format d'essai 17g (6,99$), Format moyen 60g (19,99$), et Grand format 120g (29,99$). Le grand format offre la meilleure valeur.",
      popular: false,
      tags: ["tailles", "prix"],
    },
    {
      ...
      category: "usage",
      question:
        "Puis-je utiliser Purrify avec des bacs à litière automatiques ?",
      answer:
        "Oui, Purrify fonctionne excellemment avec les bacs à litière automatiques. Le charbon actif n'interférera pas avec les mécanismes automatiques.",
      popular: false,
    ...
    },
    {
      ...
      answer:
        "Nous acceptons toutes les cartes de crédit principales (Visa, MasterCard, American Express), PayPal, Apple Pay et Google Pay. Toutes les transactions sont sécurisées.",
      popular: false,
    ...
    },
    {
      ...
      answer:
        "Oui, nous expédions dans plusieurs pays. Les coûts varient selon la destination : États-Unis (12,99$), Royaume-Uni/UE (19,99$), Australie (24,99$).",
      popular: false,
    ...
    },
    {
      ...
      answer:
        "Oui ! Nous offrons une garantie de remboursement de 30 jours. Si vous n'êtes pas complètement satisfait, contactez-nous pour un remboursement complet.",
      popular: true,
    ...
    },
    {
      ...
      answer:
        "Vous remarquerez la différence en quelques heures ! Le signe le plus évident est la réduction dramatique des odeurs du bac à litière.",
      popular: false,
    ...
    },
    {
      ...
      answer:
        "Vous pouvez nous joindre par courriel à hello@purrify.com, via notre formulaire de contact, ou par téléphone durant les heures d'affaires.",
      popular: false,
    ...
    },
    {
      ...
      answer:
        "Absolument ! Purrify est particulièrement efficace dans les foyers multi-chats. Nous recommandons notre Grand format 120g pour les foyers avec 2-3 chats.",
      popular: false,
    ...
    },
    {
      ...
      answer:
        "Oui ! Une fois votre commande expédiée, vous recevrez un numéro de suivi par courriel. Vous pouvez suivre votre colis sur le site de Postes Canada.",
      popular: false,
    ...
    },
    {
      ...
      answer:
        "Nous offrons des prix dégressifs sur les grandes quantités. Contactez-nous directement pour discuter des options de commandes en gros et des remises disponibles.",
      popular: false,
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="keywords"
          content="Purrify FAQ, questions litière chat, sécurité charbon actif, instructions usage, info expédition"
        />
        <link rel="canonical" href="https://purrify.com/fr/learn/faq" />

        <meta
          property="og:title"
          content="Foire Aux Questions - Tout Sur Purrify"
        />
        <meta
          property="og:description"
          content="Obtenez des réponses à toutes vos questions Purrify sur l'usage, la sécurité, l'expédition et plus."
        />
                ...
                {filteredFAQs.length === 0 && (
                  <div className="text-center py-12">
                    ...
                    <p className="text-gray-500 dark:text-gray-500">
                      Essayez d'ajuster vos termes de recherche ou le filtre de
                      catégorie
                    </p>
                  </div>
                )}
          ...
          <Container>
            <div className="text-center text-white max-w-3xl mx-auto">
              ...
              <p className="text-xl mb-8 opacity-90">
                Commencez avec notre format d'essai sans risque et découvrez la
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <Link href="/fr/learn/how-it-works" className="group">
                <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg border border-[#E0EFC7] dark:border-gray-700 hover:shadow-xl transition-shadow">
                  ...
                  <p className="text-gray-600 dark:text-gray-300">
                    Apprenez la science derrière notre technologie au charbon
                    actif et pourquoi elle est si efficace.
                  </p>
                </div>
              </Link>
              ...
              <Link href="/fr/learn/cat-litter-guide" className="group">
                <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg border border-[#E0EFC7] dark:border-gray-700 hover:shadow-xl transition-shadow">
                  ...
                  <p className="text-gray-600 dark:text-gray-300">
                    Guide complet des types de litière, conseils d'entretien et
              ...
              <Link href="/fr/customers/testimonials" className="group">
                <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg border border-[#E0EFC7] dark:border-gray-700 hover:shadow-xl transition-shadow">
                  ...
                  <p className="text-gray-600 dark:text-gray-300">
                    Lisez les expériences réelles de propriétaires de chats qui
                    ont transformé leur foyer avec Purrify.
                  </p>
                </div>
              </Link>
            </div>
