...
export default function SciencePageFR() {
  ...
  const pageDescription =
    "Découvrez comment la technologie du charbon actif de Purrify élimine les odeurs au niveau moléculaire. Apprenez la science qui rend notre additif pour litière si efficace.";
  ...
  const scienceFacts = [
    {
      ...
      description:
        "Le charbon actif possède des millions de pores microscopiques qui piègent les molécules d'odeur par adsorption physique et chimique, les éliminant définitivement de l'air.",
    },
    {
      icon: Microscope,
      title: "Puissance de Surface",
      description:
        "Un seul gramme de charbon actif a une surface de 500-1500 mètres carrés - équivalent à 6-18 terrains de tennis de pouvoir anti-odeur.",
    },
    {
      icon: Zap,
      title: "Action Instantanée",
      description:
        "Contrairement aux agents masquants qui couvrent les odeurs, le charbon actif capture et retient physiquement les molécules d'odeur, offrant des résultats immédiats et durables.",
    },
    {
      icon: Shield,
      title: "Sûr et Naturel",
      description:
        "Fabriqué à partir de coques de noix de coco par chauffage contrôlé, notre charbon actif est complètement sûr pour les chats et les humains tout en étant écologique.",
    },
  ];
  ...
  const processSteps = [
    {
      ...
      description:
        "Quand les chats utilisent la litière, l'ammoniac et d'autres composés odorants sont libérés dans l'air.",
    },
    {
      step: "2",
      title: "Activation du Charbon",
      description:
        "Les particules de charbon actif de Purrify commencent immédiatement à attirer ces molécules d'odeur vers leur surface poreuse.",
    },
    {
      step: "3",
      title: "Capture Moléculaire",
      description:
        "Les molécules d'odeur sont piégées dans les pores microscopiques du charbon par les forces de van der Waals et les liaisons chimiques.",
    },
    {
      step: "4",
      title: "Élimination Permanente",
      description:
        "Une fois capturées, les molécules d'odeur restent verrouillées dans la structure du charbon, éliminant les odeurs plutôt que de les masquer.",
    },
  ];
          ...
          <Container>
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-xl text-gray-600 dark:text-gray-300 mb-8 leading-relaxed">
                Découvrez comment la technologie du charbon actif élimine les
                odeurs au niveau moléculaire, offrant un contrôle supérieur des
                odeurs qui est à la fois sûr et efficace pour vos amis félins.
              </p>
        ...
        <section className="py-16">
          <Container>
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
                Suivez le parcours des molécules d'odeur de leur libération à
                leur élimination permanente.
              </p>
            </div>
          ...
          <Container>
            <div className="text-center text-white">
              ...
              <p className="text-xl mb-8 opacity-90 max-w-3xl mx-auto">
                Notre formule de charbon actif a été testée et prouvée efficace
                pour éliminer l'ammoniac, le sulfure d'hydrogène et autres
                odeurs communes de litière.
              </p>
