      ...
      <div className="py-16 md:py-24">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none">
            <p className="text-gray-600 mb-6">{t.privacyPolicy.lastUpdated}</p>
            
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-900 mb-4">1. {t.privacyPolicy.sections[0].title}</h2>
