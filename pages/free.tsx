...
//         <div className="absolute top-20 right-10 text-indigo-200 dark:text-indigo-400 dark:text-indigo-300 opacity-30 transform rotate-12">
//           <PawPrint size={60} />
//         </div>
//         <div className="absolute bottom-20 left-10 text-indigo-200 dark:text-indigo-400 dark:text-indigo-300 opacity-30 transform -rotate-12">
//           <PawPrint size={40} />
//         </div>
...
//                 <div className="bg-red-600 text-white dark:text-gray-100 dark:text-white dark:text-gray-100 text-sm font-bold px-6 py-2 rounded-full shadow-lg animate-pulse">
...
//                     priority
//                   />
//                   <div className="absolute -bottom-3 -right-3 bg-gradient-to-r from-indigo-600 to-purple-600 text-white dark:text-gray-100 dark:text-white dark:text-gray-100 px-4 py-1 rounded-full text-sm font-bold shadow-md z-20 animate-pulse">
//                     FREE
//                   </div>
//                 </div>
//               </div>
...
//                 <PawPrint className="h-6 w-6 text-red-600 dark:text-red-400 dark:text-red-400 dark:text-red-400 mt-1 flex-shrink-0" />
//                 <div>
...
//                     />
//                   </div>
//                   <h3 className="text-xl font-bold text-indigo-800 dark:text-indigo-200 mb-4">What You Get Absolutely FREE:</h3>
...
//                   <h3 className="text-xl font-bold text-red-600 dark:text-red-400 dark:text-red-400 mb-2">WARNING: This Offer Disappears in:</h3>
//                   <div className="flex justify-center space-x-4 mb-2">
//                     <div className="bg-red-600 text-white dark:text-gray-100 dark:text-white px-3 py-2 rounded-md font-mono">{timeLeft.hours.toString().padStart(2, '0')}</div>
//                     <div className="bg-red-600 text-white dark:text-gray-100 dark:text-white px-3 py-2 rounded-md font-mono">{timeLeft.minutes.toString().padStart(2, '0')}</div>
//                     <div className="bg-red-600 text-white dark:text-gray-100 dark:text-white px-3 py-2 rounded-md font-mono">{timeLeft.seconds.toString().padStart(2, '0')}</div>
//                   </div>
//                   <div className="flex justify-center text-xs text-gray-600 dark:text-gray-300 dark:text-gray-300 dark:text-gray-300 space-x-16 mb-4">
//                     <span>HOURS</span>
//                     <span>MINS</span>
//                     <span>SECS</span>
//                   </div>
//                   <p className="text-center text-red-800 dark:text-red-200 dark:text-red-200 font-medium">Limited to first 500 cat owners only.</p>
//                   <p className="text-center text-red-800 dark:text-red-200 font-medium">Already claimed: {claimedBags} out of 500</p>
...
//                   <h3 className="text-xl font-bold text-indigo-800 dark:text-indigo-200 mb-4">What Our Beta Testers Are Saying:</h3>
...
//                       <p className="text-right font-medium text-indigo-600 dark:text-indigo-400 dark:text-indigo-400">- Jennifer M., Montreal</p>
//                     </div>
//                     <div className="bg-white dark:bg-gray-800 p-3 rounded-md shadow-sm">
...
//                 <p className="text-xs text-center text-gray-500 dark:text-gray-400 dark:text-gray-400 dark:text-gray-400 mt-6">
