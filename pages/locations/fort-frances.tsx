...
export default function fortfrancesPage() {
  const city = {
    name: 'Fort Frances',
    province: 'Ontario',
    population: 15000,
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-gray-50 dark:bg-gray-700 p-6 rounded-lg border border-gray-200 dark:border-gray-600">
                ...
                <p className="italic mb-4 text-gray-700 dark:text-gray-200">
                  "Our Fort Frances family loves Purrify! Works great in our home, and the kids can have friends over without any worries."
                </p>
