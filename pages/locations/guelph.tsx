...
export default function guelphPage() {
  ...
  const seoDescription = `Eliminate cat litter odors in ${city.name}, ${city.province}. Free shipping across ${city.province}. Trusted by 270+ cat owners.`;
        ...
        <section className="py-20 px-4">
          <div className="max-w-6xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl text-gray-700 dark:text-gray-200 mb-8">
              Trusted by 270+ cat owners in {city.name} and across {city.province}
            </p>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-gray-50 dark:bg-gray-700 p-6 rounded-lg border border-gray-200 dark:border-gray-600">
                ...
                <p className="italic mb-4 text-gray-700 dark:text-gray-200">
                  "Our Guelph family loves Purrify! Works great in our home, and the kids can have friends over without any worries."
                </p>
