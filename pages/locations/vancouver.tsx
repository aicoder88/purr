        ...
        <section className="py-20 px-4">
          <div className="max-w-6xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl text-gray-700 dark:text-gray-200 mb-8">
              Trusted by 280+ cat owners in {city.name} and across {city.province}
            </p>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-gray-50 dark:bg-gray-700 p-6 rounded-lg">
                ...
                <p className="font-semibold text-gray-900 dark:text-gray-50">- Emma T., {city.name}</p>
              </div>
              <div className="bg-gray-50 dark:bg-gray-700 p-6 rounded-lg">
                <div className="flex items-center mb-4">
                  {[1,2,3,4,5].map((star) => (
                ...
                <p className="italic mb-4 text-gray-700 dark:text-gray-200">
                  "Finally something that keeps my condo fresh! No more worrying about guests noticing the litter box."
                </p>
                <p className="font-semibold text-gray-900 dark:text-gray-50">- Jason P., {city.name}</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-16 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700">
                <h3 className="text-xl font-bold mb-2 text-gray-900 dark:text-gray-50">
                  Is Purrify truly eco-friendly?
                </h3>
                <p className="text-gray-700 dark:text-gray-200">
                  Absolutely! Purrify is 100% natural activated carbon - the same material used in water filters. No chemicals, no synthetic fragrances, completely biodegradable.
                </p>
              </div>
            </div>
          </div>
