...
export default function saintbonifacePage() {
  const city = {
    name: 'Saint Boniface',
    province: 'Manitoba',
    population: 15000,
    ...
    <>
      <NextSeo
        ...
        additionalMetaTags={[
          ...
          {
            name: 'geo.placename',
            content: 'Saint Boniface',
          },
        ]}
      />

      <LocationSchema
        cityName='Saint Boniface'
        province='Manitoba'
        locale='en'
      />
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-gray-50 dark:bg-gray-700 p-6 rounded-lg border border-gray-200 dark:border-gray-600">
                ...
                <p className="italic mb-4 text-gray-700 dark:text-gray-200">
                  "Manitoba winters mean we're indoors a lot. Purrify keeps our Saint Boniface home fresh even when we can't open windows!"
                </p>
              ...
              <div className="bg-gray-50 dark:bg-gray-700 p-6 rounded-lg border border-gray-200 dark:border-gray-600">
                ...
                <p className="italic mb-4 text-gray-700 dark:text-gray-200">
                  "Reliable and effective - just like us prairie folk! Works great in our Saint Boniface home year-round."
                </p>
        ...
        <section className="py-16 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700">
                <h3 className="text-xl font-bold mb-2 text-gray-900 dark:text-gray-50">
                  Does Purrify work in extreme temperatures?
                </h3>
                <p className="text-gray-700 dark:text-gray-200">
                  Yes! Activated carbon works in any temperature. Perfect for Manitoba's extreme winters and summers - keeps your home fresh no matter the weather outside.
                </p>
              </div>
            </div>
          </div>
