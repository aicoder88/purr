...
export default function fortsmithPage() {
  const city = {
    name: 'Fort Smith',
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-gray-50 dark:bg-gray-700 p-6 rounded-lg border border-gray-200 dark:border-gray-600">
                ...
                <p className="italic mb-4 text-gray-700 dark:text-gray-200">
                  "Purrify works great in our Fort Smith home! Simple, natural, and effective - exactly what we need up here."
                </p>
              ...
              <div className="bg-gray-50 dark:bg-gray-700 p-6 rounded-lg border border-gray-200 dark:border-gray-600">
                ...
                <p className="italic mb-4 text-gray-700 dark:text-gray-200">
                  "Reliable odor control for our northern household. Our Fort Smith cats and family all appreciate the fresh air!"
                </p>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700">
                ...
                <p className="text-gray-700 dark:text-gray-200">
                  Yes! We ship across Canada including Fort Smith. Free shipping on all orders, typically arriving within 3-5 business days.
                </p>
              </div>
            </div>
          </div>
