            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-gray-50 dark:bg-gray-700 p-6 rounded-lg border border-gray-200 dark:border-gray-600">
                ...
                <p className="italic mb-4 text-gray-700 dark:text-gray-200">
                  "Our Fort McMurray home stays fresh year-round with Alberta's dry climate. Purrify works perfectly with our active lifestyle!"
                </p>
                <p className="font-semibold text-gray-900 dark:text-gray-50">- Michael B., {city.name}</p>
              </div>
              <div className="bg-gray-50 dark:bg-gray-700 p-6 rounded-lg border border-gray-200 dark:border-gray-600">
                <div className="flex items-center mb-4">
                  {[1,2,3,4,5].map((star) => (
                ...
                <p className="italic mb-4 text-gray-700 dark:text-gray-200">
                  "Great for busy families in Fort McMurray. No fuss, just results. Our cats love it and so do we!"
                </p>
                <p className="font-semibold text-gray-900 dark:text-gray-50">- Robert S., {city.name}</p>
              </div>
            </div>
          </div>
        </section>
