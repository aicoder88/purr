...
export default function saintanthonyPage() {
  const city = {
    name: 'Saint Anthony',
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-gray-50 dark:bg-gray-700 p-6 rounded-lg border border-gray-200 dark:border-gray-600">
                ...
                <p className="italic mb-4 text-gray-700 dark:text-gray-200">
                  "Newfoundland hospitality means keeping a fresh home! Purrify works perfectly in our Saint Anthony house, even with two cats by the bay!"
                </p>
              ...
              <div className="bg-gray-50 dark:bg-gray-700 p-6 rounded-lg border border-gray-200 dark:border-gray-600">
                ...
                <p className="italic mb-4 text-gray-700 dark:text-gray-200">
                  "Reliable as the tides! Our Saint Anthony family trusts Purrify to keep our home smelling fresh no matter the weather."
                </p>
        ...
        <section className="py-16 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700">
                <h3 className="text-xl font-bold mb-2 text-gray-900 dark:text-gray-50">
                  Does Purrify work in coastal climates?
                </h3>
                <p className="text-gray-700 dark:text-gray-200">
                  Absolutely! The activated carbon works great in Newfoundland's humid coastal climate. It controls both odors and moisture effectively.
                </p>
              </div>
            </div>
          </div>
