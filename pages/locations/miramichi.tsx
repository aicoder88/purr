...
export default function miramichiPage() {
  const city = {
    name: 'Miramichi',
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-gray-50 dark:bg-gray-700 p-6 rounded-lg border border-gray-200 dark:border-gray-600">
                ...
                <p className="italic mb-4 text-gray-700 dark:text-gray-200">
                  "Maritime hospitality means our home is always ready for guests. Purrify keeps our Miramichi home welcoming!"
                </p>
              ...
              <div className="bg-gray-50 dark:bg-gray-700 p-6 rounded-lg border border-gray-200 dark:border-gray-600">
                ...
                <p className="italic mb-4 text-gray-700 dark:text-gray-200">
                  "Great for Maritime homes! Works in our Miramichi house through all seasons. Highly recommend!"
                </p>
