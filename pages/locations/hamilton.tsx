            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-gray-50 dark:bg-gray-700 p-6 rounded-lg">
                ...
                <p className="italic mb-4 text-gray-700 dark:text-gray-200">
                  "Perfect for our older home on the Mountain! No more litter box smell even in our finished basement."
                </p>
                <p className="font-semibold text-gray-900 dark:text-gray-50">- Amanda K., Hamilton</p>
              </div>
              <div className="bg-gray-50 dark:bg-gray-700 p-6 rounded-lg">
                <div className="flex items-center mb-4">
                  {[1,2,3,4,5].map((star) => (
                ...
                <p className="italic mb-4 text-gray-700 dark:text-gray-200">
                  "Affordable and actually works! Great value for families in Hamilton. My three cats and my wallet are both happy."
                </p>
                <p className="font-semibold text-gray-900 dark:text-gray-50">- Rob S., Hamilton</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-16 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700">
                <h3 className="text-xl font-bold mb-2 text-gray-900 dark:text-gray-50">
                  Is Purrify safe for multiple cats?
                </h3>
                <p className="text-gray-700 dark:text-gray-200">
                  Absolutely! Purrify is 100% natural and safe for households with multiple cats. Just sprinkle it on top of your existing litter - the more cats, the more you'll appreciate it!
                </p>
              </div>
            </div>
          </div>
