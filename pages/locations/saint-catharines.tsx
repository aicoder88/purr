...
export default function saintcatharinesPage() {
  const city = {
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-gray-50 dark:bg-gray-700 p-6 rounded-lg border border-gray-200 dark:border-gray-600">
                ...
                <p className="italic mb-4 text-gray-700 dark:text-gray-200">
                  "Our Saint Catharines family loves Purrify! Works great in our home, and the kids can have friends over without any worries."
                </p>
              ...
              <div className="bg-gray-50 dark:bg-gray-700 p-6 rounded-lg border border-gray-200 dark:border-gray-600">
                ...
                <p className="italic mb-4 text-gray-700 dark:text-gray-200">
                  "Affordable and effective! Perfect for Ontario families who need real solutions that fit the budget."
                </p>
                <p className="font-semibold text-gray-900 dark:text-gray-50">- David T., {city.name}</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-16 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700">
                <h3 className="text-xl font-bold mb-2 text-gray-900 dark:text-gray-50">
                  Is Purrify safe for families with children?
                </h3>
                <p className="text-gray-700 dark:text-gray-200">
                  Yes! Purrify is 100% natural with no chemicals, fragrances, or additives. Completely safe for homes with kids, pets, and everyone in between.
                </p>
              </div>
            </div>
          </div>
