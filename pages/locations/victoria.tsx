...
export default function victoriaPage() {
  ...
  const seoDescription = `Eliminate cat litter odors in ${city.name}, ${city.province}. Free shipping across ${city.province}. Trusted by 180+ cat owners.`;
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-gray-50 dark:bg-gray-700 p-6 rounded-lg border border-gray-200 dark:border-gray-600">
                ...
                <p className="italic mb-4 text-gray-700 dark:text-gray-200">
                  "Perfect for our eco-conscious Victoria household! Natural, sustainable, and it actually works better than chemical alternatives."
                </p>
