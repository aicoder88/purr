...
export default function rosslandPage() {
  const city = {
    name: 'Rossland',
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-gray-50 dark:bg-gray-700 p-6 rounded-lg border border-gray-200 dark:border-gray-600">
                ...
                <p className="italic mb-4 text-gray-700 dark:text-gray-200">
                  "Perfect for our eco-conscious Rossland household! Natural, sustainable, and it actually works better than chemical alternatives."
                </p>
