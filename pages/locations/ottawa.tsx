        ...
        <section className="py-20 px-4">
          <div className="max-w-6xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl text-gray-700 dark:text-gray-200 mb-8">
              Trusted by 190+ cat owners across {city.province}
            </p>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-gray-50 dark:bg-gray-700 p-6 rounded-lg">
                ...
                <p className="italic mb-4 text-gray-700 dark:text-gray-200">
                  "Working from home in Ottawa means my apartment needs to stay fresh. Purrify handles my cat's litter box odor perfectly - even during video meetings!"
                </p>
                <p className="font-semibold text-gray-900 dark:text-gray-50">- Marie L., Ottawa</p>
              </div>
              <div className="bg-gray-50 dark:bg-gray-700 p-6 rounded-lg">
                <div className="flex items-center mb-4">
                  {[1,2,3,4,5].map((star) => (
                ...
                <p className="italic mb-4 text-gray-700 dark:text-gray-200">
                  "My bilingual household now has one thing in common - we all agree Purrify is the best odor solution we've found in the capital!"
                </p>
                <p className="font-semibold text-gray-900 dark:text-gray-50">- Philippe D., Ottawa</p>
              </div>
            </div>
          </div>
        </section>
