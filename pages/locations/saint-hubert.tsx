...
export default function sainthubertPage() {
  const city = {
    name: 'Saint-Hubert',
    province: 'Quebec',
    population: 15000,
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-gray-50 dark:bg-gray-700 p-6 rounded-lg border border-gray-200 dark:border-gray-600">
                ...
                <p className="italic mb-4 text-gray-700 dark:text-gray-200">
                  "Parfait pour notre maison à Saint-Hubert! Purrify garde tout frais et naturel."
                </p>
              ...
              <div className="bg-gray-50 dark:bg-gray-700 p-6 rounded-lg border border-gray-200 dark:border-gray-600">
                ...
                <p className="italic mb-4 text-gray-700 dark:text-gray-200">
                  "Natural and effective! Works great in our Saint-Hubert apartment. Highly recommend to fellow cat owners!"
                </p>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700">
                ...
                <p className="text-gray-700 dark:text-gray-200">
                  Oui! Livraison gratuite partout au Québec, incluant Saint-Hubert. Orders arrive within 2-3 business days. Support disponible en français!
                </p>
              </div>
            </div>
          </div>
