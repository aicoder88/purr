...
export default function summersidePage() {
  const city = {
    name: 'Summerside',
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-gray-50 dark:bg-gray-700 p-6 rounded-lg border border-gray-200 dark:border-gray-600">
                ...
                <p className="italic mb-4 text-gray-700 dark:text-gray-200">
                  "Island living means a small community - we recommend Purrify to all our Summerside neighbors with cats!"
                </p>
              ...
              <div className="bg-gray-50 dark:bg-gray-700 p-6 rounded-lg border border-gray-200 dark:border-gray-600">
                ...
                <p className="italic mb-4 text-gray-700 dark:text-gray-200">
                  "Perfect for our PEI home! Natural, effective, and keeps our cottage country fresh for visitors."
                </p>
        ...
        <section className="py-16 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700">
                <h3 className="text-xl font-bold mb-2 text-gray-900 dark:text-gray-50">
                  How does Purrify compare to other products?
                </h3>
                <p className="text-gray-700 dark:text-gray-200">
                  Purrify actually eliminates odors at the molecular level, unlike perfumed products that just mask smells. It's 100% natural and more effective.
                </p>
              </div>
            </div>
          </div>
