...
export default function BramptonPage() {
  const city = {
    ...
    province: 'Ontario',
    population: 656480,
    competitors: ["PetSmart","Pet Valu","Petsway"],
    keyFeatures: ["Growing suburban communities","Family homes with pets","Multi-cultural pet owners"]
  };
        ...
        <section className="py-20 px-4">
          <div className="max-w-6xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl text-gray-700 dark:text-gray-200 mb-8">
              Trusted by 600+ cat owners in Brampton and across {city.province}
            </p>
