...
export default function batochePage() {
  const city = {
    name: 'Batoche',
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-gray-50 dark:bg-gray-700 p-6 rounded-lg border border-gray-200 dark:border-gray-600">
                ...
                <p className="italic mb-4 text-gray-700 dark:text-gray-200">
                  "Simple, natural, effective - everything we value in Batoche. Purrify delivers without the fancy packaging."
                </p>
              ...
              <div className="bg-gray-50 dark:bg-gray-700 p-6 rounded-lg border border-gray-200 dark:border-gray-600">
                ...
                <p className="italic mb-4 text-gray-700 dark:text-gray-200">
                  "Great value for prairie families! Our Batoche home stays fresh without breaking the bank."
                </p>
