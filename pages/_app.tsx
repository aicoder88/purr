            ...
            additionalMetaTags={[
              {
                name: "keywords",
                content:
                  "cat litter, odor control, activated carbon, cat litter additive, pet odor, cat odor elimination, eco-friendly cat litter, natural odor control, cat care, pet supplies",
              },
              {
                name: "author",
                content: SITE_NAME,
