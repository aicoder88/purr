...
export default function OpinionesPage() {
  ...
  return (
    <>
      <Head>
        <title>{`Purrify Opiniones - Reseñas de Clientes Verificados | ${SITE_NAME}`}</title>
        <meta name="description" content="Lee opiniones verificadas de Purrify. Descubre por qué más de 1,000 dueños de gatos confían en Purrify para eliminar olores de arena naturalmente. Reseñas reales de Canadá." />
        <meta name="keywords" content="purrify opiniones, purrify reseñas, desodorizante arena gatos opiniones, eliminador olores gatos, carbón activado arena gatos" />

        {/* Open Graph */}
        <meta property="og:title" content="Purrify Opiniones - Reseñas de Clientes Verificados" />
        <meta property="og:description" content="Descubre por qué más de 1,000 dueños de gatos confían en Purrify para eliminar olores de arena con carbón activado natural." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://www.purrify.ca/es/opiniones" />
        <meta property="og:image" content="https://www.purrify.ca/optimized/three_bags_no_bg.webp" />
        <meta property="og:locale" content="es_ES" />

        {/* Twitter */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Purrify Opiniones - Reseñas Verificadas" />
