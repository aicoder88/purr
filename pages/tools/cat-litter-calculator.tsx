...
const CatLitterCalculatorPage: NextPage = () => {
  ...
  const pageTitle = 'Cat Litter Cost Calculator - Compare Litter Types & Annual Costs';
...
export default CatLitterCalculatorPage;
