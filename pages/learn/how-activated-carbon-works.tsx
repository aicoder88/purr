          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6 mb-8">
              ...
              <div className="bg-gray-50 dark:bg-gray-700 rounded-xl p-6">
                <div className="flex items-center gap-3 mb-3">
                  <span className="bg-gray-500 text-white dark:text-gray-100 font-bold px-3 py-1 rounded-full text-sm">Mesopores</span>
              ...
              <div className="bg-gray-50 dark:bg-gray-700 rounded-xl p-6">
                <div className="flex items-center gap-3 mb-3">
                  <span className="bg-gray-400 text-white dark:text-gray-100 font-bold px-3 py-1 rounded-full text-sm">Macropores</span>
