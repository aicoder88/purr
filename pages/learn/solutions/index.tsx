...
import { buildLanguageAlternates, getLocalizedUrl, generateJSONLD } from '../../../src/lib/seo-utils';
...
const SOLUTIONS: SolutionCard[] = [
  ...
  },
  {
    ...
    image: '/images/solutions/apartment-hero.png',
  ...
  },
  {
    ...
    image: '/images/solutions/ammonia-fresh-home.png',
  ...
  },
  {
    ...
    image: '/images/solutions/ammonia-happy-cat.png',
  ...
  },
  {
    ...
    image: '/images/solutions/apartment-living-room.png',
    alt: 'Comfortable solutions for senior cats',
    icon: Heart,
  },
];

const SolutionsIndexPage: NextPage = () => {
  const { locale } = useTranslation();

  const pageTitle = 'Cat Litter Odor Solutions - Expert Guides | Purrify';
  const pageDescription = 'Find the right solution for your cat litter odor problem. Expert guides for ammonia smell, apartment living, multiple cats, senior cats, and more.';
  const canonicalUrl = getLocalizedUrl('/learn/solutions', locale);
  const languageAlternates = buildLanguageAlternates('/learn/solutions');
  ...
  const collectionPageSchema = {
    ...
    'mainEntity': {
      ...
      'itemListElement': SOLUTIONS.map((solution, index) => ({
        '@type': 'ListItem',
        'position': index + 1,
        'url': `https://www.purrify.ca${solution.href}`,
        'name': solution.title,
    ...
    <>
      <NextSeo
        ...
        openGraph={{
          ...
          images: [
            {
              url: 'https://www.purrify.ca/images/solutions/ammonia-hero.png',
              width: 1200,
              height: 675,
