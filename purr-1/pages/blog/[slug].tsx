...
export default function BlogPost({ post }: { post: BlogPost }) {
  ...
  return (
    <>
      ...
      <article className="py-16 bg-gradient-to-br from-[#FFFFFF] via-[#FFFFF5] to-[#FFFFFF] dark:from-gray-900 dark:via-gray-950 dark:to-gray-900">
        <Container>
          <div className="max-w-4xl mx-auto">
            <Link 
              href="/blog" 
              className="inline-flex items-center text-[#5B2EFF] hover:text-[#5B2EFF]/80 dark:text-[#8B5CF6] dark:hover:text-[#8B5CF6]/80 mb-8"
            >
              <svg 
            ...
            <div 
              className="prose dark:prose-invert prose-lg max-w-none 
                prose-headings:text-[#5B2EFF] dark:prose-headings:text-[#8B5CF6]
                prose-a:text-[#FF3131] dark:prose-a:text-[#FF6B6B]
            ...
            <div className="mt-12 pt-8 border-t border-[#E0EFC7] dark:border-gray-700">
              <h3 className="text-xl font-bold mb-4 text-[#5B2EFF] dark:text-[#8B5CF6]">Share this article</h3>
