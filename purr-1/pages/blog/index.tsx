      ...
      <section className="py-16 bg-gradient-to-br from-[#FFFFFF] via-[#FFFFF5] to-[#FFFFFF] dark:from-gray-900 dark:via-gray-950 dark:to-gray-900">
        <Container>
          <div className="max-w-3xl mx-auto text-center mb-16">
            ...
            <h1 className="text-5xl font-bold tracking-tight mb-4 text-[#03E46A] dark:text-[#5B2EFF]">
              Purrify Blog
            </h1>
          ...
          {blogPosts.length === 0 ? (
            <div className="text-center py-20">
              <p className="text-gray-600 dark:text-gray-400">No blog posts found. Check back soon!</p>
            </div>
          ) : (
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {blogPosts.map((post, index) => (
                ...
                >
                  ...
                  <div className="p-6">
                    <h2 className="font-bold text-xl mb-3 text-[#5B2EFF] dark:text-[#8B5CF6] group-hover:text-[#5B2EFF]/80 dark:group-hover:text-[#8B5CF6]/80 transition-colors">
                      {post.title}
                    </h2>
