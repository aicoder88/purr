...
import { ArrowLeft, Check, Star, ShoppingCart, Heart, Users, Loader2 } from 'lucide-react';
import { toast } from 'sonner';
...
export default function TrialSizePage() {
  ...
  const handleBuyNow = async () => {
    setIsLoading(true);
    try {
      // Create a checkout session with the trial size product
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  <Button 
                    ...
                    className="w-full bg-gradient-to-r from-[#FF3131] to-[#FF3131]/80 hover:from-[#FF3131]/90 hover:to-[#FF3131] text-white font-bold py-4 text-lg shadow-lg hover:shadow-xl transition-all duration-300 disabled:opacity-80 disabled:cursor-not-allowed"
                  >
                    {isLoading ? (
                      <>
