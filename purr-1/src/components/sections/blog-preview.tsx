...
=======
              key={index}
              className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl overflow-hidden shadow-xl border border-[#E0EFC7] dark:border-gray-700 transition-all duration-500 hover:shadow-[#E0EFC7]/50 dark:hover:shadow-[#5B2EFF]/20 hover:-translate-y-1 group"
...
=======
                <div className="absolute top-3 right-3 sm:top-4 sm:right-4 bg-gradient-to-r from-[#03E46A] to-[#03E46A]/80 dark:from-[#5B2EFF] dark:to-[#5B2EFF]/80 px-2 py-1 sm:px-3 sm:py-1 rounded-full shadow-md text-xs text-white font-medium">
>>>>>>> 4a35066 (feat: Complete comprehensive website improvements and optimizations)
                  {t.blogSection.newPost}
                </div>
              </div>
              <div className="p-4 sm:p-6">
                <h3 className="font-bold text-lg sm:text-xl mb-2 sm:mb-3 text-[#5B2EFF] dark:text-[#8B5CF6] group-hover:text-[#5B2EFF]/80 dark:group-hover:text-[#8B5CF6]/80 transition-colors">
                  {post.title}
                </h3>
                ...
                <div className="flex justify-between items-center text-xs sm:text-sm">
                  <span className="text-[#03E46A] dark:text-[#5B2EFF] font-medium">
                    {post.author}
                  </span>
