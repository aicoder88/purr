...
export default function SciencePageClient() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-[#FFFFFF] via-[#FFFFF5] to-[#FFFFFF] from-gray-900 via-gray-950 to-gray-900">
        ...
        <Container>
          <div className="text-center max-w-4xl mx-auto">
            <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-r from-[#FF3131] to-[#5B2EFF] rounded-full mb-6">
              <FlaskConical className="w-8 h-8 text-white text-gray-100" />
            </div>
            ...
            <Link href={`${locale === 'fr' ? '/fr' : ''}/products/trial-size`}>
              <Button size="lg" className="bg-gradient-to-r from-[#FF3131] to-[#FF3131]/80 hover:from-[#FF3131]/90 hover:to-[#FF3131] text-white text-gray-100 font-bold shadow-lg hover:shadow-xl transition-all duration-300">
      ...
      <section className="py-16 bg-gradient-to-br from-red-50 to-orange-50 from-red-900/10 to-orange-900/10">
        <Container>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            <div className="bg-white bg-gray-800 rounded-2xl p-8 shadow-xl border border-red-200 border-red-900">
              <div className="text-center mb-6">
                <div className="inline-flex items-center justify-center w-16 h-16 bg-red-100 bg-red-900/30 rounded-full mb-4">
                  <span className="text-3xl">💧</span>
                </div>
                <h3 className="font-heading text-2xl font-bold text-gray-900 text-white mb-2">{t('sciencePage.understanding.ammonia.title')}</h3>
                <p className="text-sm text-red-600 text-red-400 font-semibold">{t('sciencePage.understanding.ammonia.subtitle')}</p>
              </div>
              <ul className="space-y-3 text-gray-700 text-gray-200">
                <li className="flex items-start space-x-2">
                  <span className="text-red-500 text-red-400 mt-1">•</span>
            ...
            <div className="bg-white bg-gray-800 rounded-2xl p-8 shadow-xl border border-yellow-200 border-yellow-900">
              <div className="text-center mb-6">
                <div className="inline-flex items-center justify-center w-16 h-16 bg-yellow-100 bg-yellow-900/30 rounded-full mb-4">
                  <span className="text-3xl">💩</span>
                </div>
                <h3 className="font-heading text-2xl font-bold text-gray-900 text-white mb-2">{t('sciencePage.understanding.mercaptans.title')}</h3>
                <p className="text-sm text-yellow-600 text-yellow-400 font-semibold">{t('sciencePage.understanding.mercaptans.subtitle')}</p>
              </div>
              <ul className="space-y-3 text-gray-700 text-gray-200">
                <li className="flex items-start space-x-2">
                  <span className="text-yellow-500 text-yellow-400 mt-1">•</span>
          ...
          <div className="mt-10 text-center bg-white bg-gray-800 rounded-2xl p-8 max-w-3xl mx-auto shadow-lg border border-gray-200 border-gray-700">
            <p className="text-lg text-gray-700 text-gray-200 leading-relaxed">
      ...
      <section className="py-16 bg-gradient-to-br from-blue-50 to-purple-50 from-blue-900/10 to-purple-900/10">
        <Container>
          <div className="text-center mb-12">
            <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-r from-blue-600 to-purple-600 rounded-full mb-6">
              <BarChart3 className="w-8 h-8 text-white text-gray-100" />
            </div>
            <h2 className="font-heading text-3xl md:text-4xl font-bold mb-4 text-gray-900 text-white">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-12">
            <div className="bg-white bg-gray-800 rounded-2xl p-8 shadow-lg border-2 border-blue-200 border-blue-800">
              <div className="text-center mb-4">
                <div className="text-5xl font-bold text-blue-600 text-blue-400 mb-2">{t('sciencePage.poreSize.micropores.size')}</div>
                <h3 className="font-heading text-xl font-bold text-gray-900 text-white mb-2">{t('sciencePage.poreSize.micropores.title')}</h3>
                <p className="text-sm text-gray-500 text-gray-400 uppercase tracking-wide">{t('sciencePage.poreSize.micropores.specialist')}</p>
              </div>
              <div className="space-y-3 text-gray-700 text-gray-200">
            ...
            <div className="bg-white bg-gray-800 rounded-2xl p-8 shadow-lg border-2 border-purple-200 border-purple-800">
              <div className="text-center mb-4">
                <div className="text-5xl font-bold text-purple-600 text-purple-400 mb-2">{t('sciencePage.poreSize.mesopores.size')}</div>
                <h3 className="font-heading text-xl font-bold text-gray-900 text-white mb-2">{t('sciencePage.poreSize.mesopores.title')}</h3>
                <p className="text-sm text-gray-500 text-gray-400 uppercase tracking-wide">{t('sciencePage.poreSize.mesopores.specialist')}</p>
              </div>
              <div className="space-y-3 text-gray-700 text-gray-200">
            ...
            <div className="bg-white bg-gray-800 rounded-2xl p-8 shadow-lg border-2 border-indigo-200 border-indigo-800">
              <div className="text-center mb-4">
                <div className="text-5xl font-bold text-indigo-600 text-indigo-400 mb-2">{t('sciencePage.poreSize.macropores.size')}</div>
                <h3 className="font-heading text-xl font-bold text-gray-900 text-white mb-2">{t('sciencePage.poreSize.macropores.title')}</h3>
                <p className="text-sm text-gray-500 text-gray-400 uppercase tracking-wide">{t('sciencePage.poreSize.macropores.specialist')}</p>
              </div>
              <div className="space-y-3 text-gray-700 text-gray-200">
          ...
          <div className="bg-white bg-gray-800 rounded-2xl p-8 shadow-xl border border-gray-200 border-gray-700 max-w-4xl mx-auto">
            <h3 className="font-heading text-2xl font-bold text-gray-900 text-white mb-4 text-center">
              {t('sciencePage.poreSize.surfaceArea.title')}
            </h3>
            <p className="text-center text-gray-600 text-gray-300 mb-6 text-lg">
              {t('sciencePage.poreSize.surfaceArea.description')}
            </p>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
              <div className="p-4 bg-gradient-to-br from-blue-50 to-blue-100 from-blue-900/20 to-blue-800/20 rounded-xl">
                <div className="text-2xl font-bold text-blue-600 text-blue-400 mb-1">≥1000</div>
                <div className="text-xs text-gray-600 text-gray-300">{t('sciencePage.poreSize.surfaceArea.iodineNumber') || 'Iodine Number mg/g'}</div>
              </div>
              <div className="p-4 bg-gradient-to-br from-purple-50 to-purple-100 from-purple-900/20 to-purple-800/20 rounded-xl">
                <div className="text-2xl font-bold text-purple-600 text-purple-400 mb-1">≥50%</div>
                <div className="text-xs text-gray-600 text-gray-300">{t('sciencePage.poreSize.surfaceArea.ctcAdsorption') || 'CTC Adsorption'}</div>
              </div>
              <div className="p-4 bg-gradient-to-br from-green-50 to-green-100 from-green-900/20 to-green-800/20 rounded-xl">
                <div className="text-2xl font-bold text-green-600 text-green-400 mb-1">≥98%</div>
                <div className="text-xs text-gray-600 text-gray-300">{t('sciencePage.poreSize.surfaceArea.hardness') || 'Hardness'}</div>
              </div>
              <div className="p-4 bg-gradient-to-br from-red-50 to-red-100 from-red-900/20 to-red-800/20 rounded-xl">
                <div className="text-2xl font-bold text-red-600 text-red-400 mb-1">≤5%</div>
                <div className="text-xs text-gray-600 text-gray-300">{t('sciencePage.poreSize.surfaceArea.moisture') || 'Moisture'}</div>
              </div>
            </div>
          </div>
        </Container>
      ...
      {/* Science Facts Grid */}
      <section className="py-16 bg-white bg-gray-900/50 bg-gray-800/20">
        <Container>
          <div className="text-center mb-12">
            <h2 className="font-heading text-3xl md:text-4xl font-bold mb-4 text-gray-900 text-white">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
            {scienceFacts.map((fact) => (
              <div
                key={fact.title}
                className="bg-white bg-gray-800 rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 border-gray-700"
              >
                <div className="flex items-start space-x-4">
                  <div className="flex-shrink-0">
                    <div className="w-12 h-12 bg-gradient-to-r from-[#FF3131] to-[#5B2EFF] rounded-lg flex items-center justify-center">
                      <fact.icon className="w-6 h-6 text-white text-gray-100" />
                    </div>
                  </div>
                  <div>
                    <h3 className="font-heading text-xl font-bold mb-3 text-gray-900 text-white">
                      {fact.title}
                    </h3>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
              <div className="space-y-6">
                <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 to-transparent p-6">
                    <p className="text-white text-gray-100 text-sm font-medium">{t('sciencePage.microscopicView.imageCaptions.microscope')}</p>
                  </div>
                </div>
                <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                  <Image
                  ...
                  />
                  <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 to-transparent p-6">
                    <p className="text-white text-gray-100 text-sm font-medium">{t('sciencePage.microscopicView.imageCaptions.labTesting')}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-6">
                <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                  ...
                  />
                  <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 to-transparent p-6">
                    <p className="text-white text-gray-100 text-sm font-medium">{t('sciencePage.microscopicView.imageCaptions.molecular')}</p>
                  </div>
                </div>

                <div className="bg-gradient-to-br from-[#FF3131]/10 to-[#5B2EFF]/10 from-[#FF3131]/20 to-[#5B2EFF]/20 rounded-2xl p-6 border border-[#FF3131]/20 border-[#5B2EFF]/30">
                  <h3 className="font-heading text-2xl font-bold text-gray-900 text-white mb-3">
                    {t('sciencePage.microscopicView.whatYoureLookingAt.title')}
                  </h3>
                  <p className="text-gray-700 text-gray-200 leading-relaxed mb-4">
                ...
                <div className="bg-white bg-gray-800 rounded-xl p-6 shadow-lg border border-gray-200 border-gray-700">
                  <p className="text-gray-700 text-gray-200 italic">
                    {t('sciencePage.microscopicView.quote.text')}
                  </p>
                  <p className="text-sm text-gray-500 text-gray-400 mt-3">{t('sciencePage.microscopicView.quote.attribution')}</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 bg-gradient-to-br from-slate-50 to-gray-50 from-slate-900/20 to-gray-900/20">
        <Container>
          <div className="text-center mb-12">
            <h2 className="font-heading text-3xl md:text-4xl font-bold mb-4 text-gray-900 text-white">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            <div className="bg-white bg-gray-800 rounded-2xl p-8 shadow-xl border border-gray-200 border-gray-700">
              <h3 className="font-heading text-xl font-bold text-gray-900 text-white mb-6 flex items-center">
                <span className="w-10 h-10 bg-blue-100 bg-blue-900/30 rounded-lg flex items-center justify-center mr-3">
                  <BarChart3 className="w-5 h-5 text-blue-600 text-blue-400" />
                </span>
                {t('sciencePage.technicalPerformance.particleSize.title')}
              </h3>
              <div className="space-y-4">
                <div className="flex justify-between items-center pb-3 border-b border-gray-200 border-gray-700">
                  <span className="text-gray-700 text-gray-200 font-medium">{t('sciencePage.technicalPerformance.particleSize.effectiveSize') || 'Effective Size:'}</span>
                  <span className="text-lg font-bold text-blue-600 text-blue-400">{t('sciencePage.technicalPerformance.particleSize.effectiveSize')}</span>
                </div>
                <div className="flex justify-between items-center pb-3 border-b border-gray-200 border-gray-700">
                  <span className="text-gray-700 text-gray-200 font-medium">{t('sciencePage.technicalPerformance.particleSize.meanDiameter') || 'Mean Diameter:'}</span>
                  <span className="text-lg font-bold text-blue-600 text-blue-400">{t('sciencePage.technicalPerformance.particleSize.meanDiameter')}</span>
                </div>
                <div className="flex justify-between items-center pb-3 border-b border-gray-200 border-gray-700">
                  <span className="text-gray-700 text-gray-200 font-medium">{t('sciencePage.technicalPerformance.particleSize.uniformityCoefficient') || 'Uniformity Coefficient:'}</span>
                  <span className="text-lg font-bold text-blue-600 text-blue-400">{t('sciencePage.technicalPerformance.particleSize.uniformityCoefficient')}</span>
                </div>
                <div className="mt-6 p-4 bg-blue-50 bg-blue-900/20 rounded-xl">
            ...
            <div className="bg-white bg-gray-800 rounded-2xl p-8 shadow-xl border border-gray-200 border-gray-700">
              <h3 className="font-heading text-xl font-bold text-gray-900 text-white mb-6 flex items-center">
                <span className="w-10 h-10 bg-purple-100 bg-purple-900/30 rounded-lg flex items-center justify-center mr-3">
                  <Zap className="w-5 h-5 text-purple-600 text-purple-400" />
                </span>
                {t('sciencePage.technicalPerformance.adsorption.title')}
              </h3>
              <div className="space-y-4">
                <div className="flex justify-between items-center pb-3 border-b border-gray-200 border-gray-700">
                  <span className="text-gray-700 text-gray-200 font-medium">{t('sciencePage.technicalPerformance.adsorption.halfLength') || 'Half-Length Value:'}</span>
                  <span className="text-lg font-bold text-purple-600 text-purple-400">{t('sciencePage.technicalPerformance.adsorption.halfLength')}</span>
                </div>
                <div className="flex justify-between items-center pb-3 border-b border-gray-200 border-gray-700">
                  <span className="text-gray-700 text-gray-200 font-medium">{t('sciencePage.technicalPerformance.adsorption.apparentDensity') || 'Apparent Density:'}</span>
                  <span className="text-lg font-bold text-purple-600 text-purple-400">{t('sciencePage.technicalPerformance.adsorption.apparentDensity')}</span>
                </div>
                <div className="flex justify-between items-center pb-3 border-b border-gray-200 border-gray-700">
                  <span className="text-gray-700 text-gray-200 font-medium">{t('sciencePage.technicalPerformance.adsorption.betSurface') || 'BET Surface Area:'}</span>
                  <span className="text-lg font-bold text-purple-600 text-purple-400">{t('sciencePage.technicalPerformance.adsorption.betSurface')}</span>
                </div>
                <div className="mt-6 p-4 bg-purple-50 bg-purple-900/20 rounded-xl">
                  <p className="text-sm text-gray-700 text-gray-200">
          ...
          <div className="mt-12 max-w-4xl mx-auto bg-white bg-gray-800 rounded-2xl p-8 shadow-xl border border-gray-200 border-gray-700">
            <div className="flex items-start space-x-4">
              <div className="flex-shrink-0">
                <div className="w-12 h-12 bg-green-100 bg-green-900/30 rounded-lg flex items-center justify-center">
                  <Microscope className="w-6 h-6 text-green-600 text-green-400" />
                </div>
              </div>
              <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-6">
                  <div className="text-center p-4 bg-gray-50 bg-gray-700/50 rounded-xl">
                    <div className="text-2xl font-bold text-green-600 text-green-400 mb-1">{t('sciencePage.engineeredPerformance.stats.temperatureRange')}</div>
                    <div className="text-sm text-gray-600 text-gray-300">{t('sciencePage.engineeredPerformance.stats.temperatureLabel')}</div>
                  </div>
                  <div className="text-center p-4 bg-gray-50 bg-gray-700/50 rounded-xl">
                    <div className="text-2xl font-bold text-green-600 text-green-400 mb-1">{uiCopy.stableValue}</div>
                    <div className="text-sm text-gray-600 text-gray-300">{t('sciencePage.engineeredPerformance.stats.performanceLabel')}</div>
                  </div>
                  <div className="text-center p-4 bg-gray-50 bg-gray-700/50 rounded-xl">
                    <div className="text-2xl font-bold text-green-600 text-green-400 mb-1">{uiCopy.minimalValue}</div>
                    <div className="text-sm text-gray-600 text-gray-300">{t('sciencePage.engineeredPerformance.stats.pressureLossLabel')}</div>
                  </div>
                </div>
              </div>
            </div>
              ...
              {processSteps.map((step, index) => (
                ...
                >
                  <div className={`w-full md:w-5/12 ${index % 2 === 0 ? 'md:pr-8' : 'md:pl-8'}`}>
                    <div className="bg-white bg-gray-800 rounded-2xl p-6 shadow-lg border border-gray-100 border-gray-700">
                      <h3 className="font-heading text-xl font-bold mb-3 text-gray-900 text-white">
                        {step.title}
                      </h3>
                      <p className="text-gray-600 text-gray-300 leading-relaxed">
                  ...
                  {/* Step number */}
                  <div className="w-16 h-16 bg-gradient-to-r from-[#FF3131] to-[#5B2EFF] rounded-full flex items-center justify-center text-white text-gray-100 font-bold text-xl shadow-lg z-10 my-4 md:my-0">
                    {step.step}
                  </div>
      ...
      <section className="py-16 bg-gradient-to-r from-[#5B2EFF] to-[#FF3131]">
        <Container>
          <div className="text-center text-white text-gray-100">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link href={`${locale === 'fr' ? '/fr' : ''}/learn/how-it-works`}>
                <Button size="lg" variant="outline" className="border-white border-gray-600 text-white text-gray-100 bg-transparent hover:bg-white/10 hover:bg-gray-700/50 transition-colors">
      ...
      {/* Back to Learn */}
      <section className="py-8 border-t border-gray-200 border-gray-800">
        <Container>
          <Link
            href={`${locale === 'fr' ? '/fr' : ''}/learn/how-it-works`}
            className="inline-flex items-center text-gray-600 text-gray-400 hover:text-[#FF3131] hover:text-[#FF5050] transition-colors"
          >
