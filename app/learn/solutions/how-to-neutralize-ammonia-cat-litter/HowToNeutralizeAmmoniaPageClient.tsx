    ...
    <div className="min-h-screen bg-[#FFFFF5] bg-gray-900 transition-colors duration-300">
      ...
      <section className="py-16 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <span className="inline-block px-4 py-1 bg-red-100 bg-red-900/30 text-red-600 text-red-400 rounded-full text-sm font-medium mb-4">
      ...
      <section className="px-4 mb-12">
        <div className="max-w-4xl mx-auto">
          <div className="bg-green-50 bg-green-900/20 border-l-4 border-green-500 border-green-400 p-6 rounded-r-xl">
            <h2 className="text-xl font-heading font-bold text-green-800 text-green-200 mb-3">
              Quick Answer: What Neutralizes Ammonia in Cat Litter?
            </h2>
            <p className="text-green-700 text-green-300 mb-4">
            ...
            <Link
              ...
              className="inline-block bg-green-600 hover:bg-green-700 text-white text-gray-100 font-bold py-2 px-6 rounded-lg transition-colors"
            >
      ...
      <section className="py-12 px-4">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-heading font-bold mb-6 text-gray-900 text-gray-100">
            Why Does Cat Litter Smell Like Ammonia?
          </h2>

          <div className="bg-white bg-gray-800 rounded-xl p-6 shadow-lg mb-8">
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-8">
            <div className="bg-yellow-50 bg-yellow-900/20 p-5 rounded-xl border border-yellow-200 border-yellow-700">
              <div className="text-2xl mb-2">🌡️</div>
              <h3 className="font-bold text-gray-900 text-gray-100 mb-2">Heat Accelerates It</h3>
              <p className="text-sm text-gray-600 text-gray-300">
                Warm temperatures speed up bacterial activity and ammonia release
              </p>
            </div>
            <div className="bg-blue-50 bg-blue-900/20 p-5 rounded-xl border border-blue-200 border-blue-700">
              <div className="text-2xl mb-2">💧</div>
              <h3 className="font-bold text-gray-900 text-gray-100 mb-2">Moisture Makes It Worse</h3>
              <p className="text-sm text-gray-600 text-gray-300">
                High humidity keeps urine liquid, allowing more ammonia to evaporate
              </p>
            </div>
            <div className="bg-purple-50 bg-purple-900/20 p-5 rounded-xl border border-purple-200 border-purple-700">
              <div className="text-2xl mb-2">🐱</div>
              <h3 className="font-bold text-gray-900 text-gray-100 mb-2">More Cats = More Ammonia</h3>
              <p className="text-sm text-gray-600 text-gray-300">
      ...
      <section className="py-12 px-4 bg-white bg-gray-800">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-heading font-bold mb-8 text-center text-gray-900 text-gray-100">
            5 Methods to Neutralize Ammonia (Ranked)
          </h2>

          {/* Method 1 - Best */}
          <div className="bg-gradient-to-r from-green-50 to-emerald-50 from-green-900/20 to-emerald-900/20 rounded-xl p-6 mb-6 border-2 border-green-500 border-green-400">
            <div className="flex items-center gap-3 mb-4">
              <span className="bg-green-500 text-white text-gray-100 font-bold px-3 py-1 rounded-full text-sm">BEST</span>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                ...
                <ul className="space-y-2 text-gray-700 text-gray-200">
                  <li className="flex items-start gap-2">
                    <span className="text-green-500 text-green-400">✓</span>
              ...
              <div className="flex flex-col justify-center">
                <div className="bg-white bg-gray-700 rounded-lg p-4 text-center">
                  <div className="text-4xl font-bold text-green-600 text-green-400 mb-1">92%</div>
                  <div className="text-sm text-gray-600 text-gray-300">Ammonia reduction in lab tests</div>
                </div>
              </div>
            </div>
          </div>
          ...
          {/* Method 2 */}
          <div className="bg-gray-50 bg-gray-700 rounded-xl p-6 mb-6">
            <div className="flex items-center gap-3 mb-4">
              <span className="bg-gray-600 bg-gray-500 text-white text-gray-100 font-bold px-3 py-1 rounded-full text-sm">#2</span>
              <h3 className="text-2xl font-heading font-bold text-gray-900 text-gray-100">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div>
                <h4 className="font-bold text-green-600 text-green-400 mb-2">Pros:</h4>
              ...
              <div>
                <h4 className="font-bold text-red-600 text-red-400 mb-2">Cons:</h4>
                <ul className="text-sm text-gray-600 text-gray-300 space-y-1">
          ...
          <div className="bg-gray-50 bg-gray-700 rounded-xl p-6 mb-6">
            <div className="flex items-center gap-3 mb-4">
              <span className="bg-gray-600 bg-gray-500 text-white text-gray-100 font-bold px-3 py-1 rounded-full text-sm">#3</span>
              <h3 className="text-2xl font-heading font-bold text-gray-900 text-gray-100">
                Zeolite Additives
              </h3>
            </div>
          ...
          <div className="bg-gray-50 bg-gray-700 rounded-xl p-6 mb-6">
            <div className="flex items-center gap-3 mb-4">
              <span className="bg-gray-600 bg-gray-500 text-white text-gray-100 font-bold px-3 py-1 rounded-full text-sm">#4</span>
              <h3 className="text-2xl font-heading font-bold text-gray-900 text-gray-100">
          ...
          {/* Method 5 - Avoid */}
          <div className="bg-red-50 bg-red-900/20 rounded-xl p-6 mb-6 border border-red-200 border-red-700">
            <div className="flex items-center gap-3 mb-4">
              <span className="bg-red-500 text-white text-gray-100 font-bold px-3 py-1 rounded-full text-sm">AVOID</span>
              <h3 className="text-2xl font-heading font-bold text-gray-900 text-gray-100">
            ...
            <ul className="text-red-700 text-red-300 space-y-2">
              <li className="flex items-start gap-2">
                <span>✗</span>
      ...
      <section className="py-12 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="overflow-x-auto">
            <table className="w-full bg-white bg-gray-800 rounded-xl shadow-lg overflow-hidden">
              <thead className="bg-gray-100 bg-gray-700">
                <tr>
                  ...
                  <th className="px-4 py-3 text-center text-gray-900 text-gray-100">Cat Safe</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-gray-200 divide-gray-600">
                <tr className="bg-green-50 bg-green-900/20">
                  ...
                  <td className="px-4 py-3 text-center text-green-600 text-green-400">✓</td>
                </tr>
                <tr>
                ...
                <tr>
                  <td className="px-4 py-3 font-medium text-gray-900 text-gray-100">Scented Products</td>
                  ...
                  <td className="px-4 py-3 text-center text-red-600 text-red-400">✗</td>
                </tr>
              </tbody>
            </table>
          </div>
      ...
      <section className="py-12 px-4">
        <div className="max-w-4xl mx-auto">
          <div className="bg-red-50 bg-red-900/20 border-l-4 border-red-500 border-red-400 p-6 rounded-r-xl">
            <h2 className="text-xl font-heading font-bold text-red-800 text-red-200 mb-3">
              Health Warning: Ammonia Exposure Risks
            </h2>
            <p className="text-red-700 text-red-300 mb-4">
      ...
      <section className="py-12 px-4 bg-gray-50 bg-gray-800">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <Link href="/learn/solutions/ammonia-smell-cat-litter/" className="bg-white bg-gray-700 rounded-xl p-5 shadow-md hover:shadow-lg hover:scale-105 transition-all duration-300">
              <h3 className="font-bold text-gray-900 text-gray-100 mb-2">Cat Litter Smells Like Ammonia?</h3>
              <p className="text-sm text-gray-600 text-gray-300">Quick fixes for immediate relief</p>
            </Link>
            <Link href="/learn/activated-carbon-vs-baking-soda-deodorizers" className="bg-white bg-gray-700 rounded-xl p-5 shadow-md hover:shadow-lg hover:scale-105 transition-all duration-300">
              <h3 className="font-bold text-gray-900 text-gray-100 mb-2">Activated Carbon vs Baking Soda</h3>
              <p className="text-sm text-gray-600 text-gray-300">Side-by-side comparison results</p>
            </Link>
            <Link href="/learn/solutions/apartment-cat-smell-solution/" className="bg-white bg-gray-700 rounded-xl p-5 shadow-md hover:shadow-lg hover:scale-105 transition-all duration-300">
              <h3 className="font-bold text-gray-900 text-gray-100 mb-2">Apartment Odor Solutions</h3>
              <p className="text-sm text-gray-600 text-gray-300">For small spaces with poor ventilation</p>
            </Link>
          </div>
        </div>
      </section>
