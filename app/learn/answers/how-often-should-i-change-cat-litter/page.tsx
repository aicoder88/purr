        ...
        <div className="prose prose-lg max-w-none">
          ...
          <div className="border-t border-gray-200 pt-8">
              ...
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="border-b-2 border-gray-200">
                    <th className="py-3 px-4 font-semibold text-gray-900">Litter Type</th>
                    <th className="py-3 px-4 font-semibold text-gray-900">Scoop</th>
                    <th className="py-3 px-4 font-semibold text-gray-900">Full Change</th>
                    <th className="py-3 px-4 font-semibold text-gray-900">With Carbon</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-gray-100">
                  <tr className="bg-green-50/50">
                    <td className="py-4 px-4 font-medium text-gray-900">Clumping Clay</td>
                    <td className="py-4 px-4 text-gray-700">Daily</td>
                    <td className="py-4 px-4 text-gray-700">1-2 weeks</td>
                    <td className="py-4 px-4 text-green-700 font-medium">2-3 weeks</td>
                  </tr>
                  <tr>
                    <td className="py-4 px-4 font-medium text-gray-900">Crystal</td>
                    <td className="py-4 px-4 text-gray-700">Stir daily</td>
                    <td className="py-4 px-4 text-gray-700">2-4 weeks</td>
                    <td className="py-4 px-4 text-gray-500">—</td>
                  </tr>
                  <tr className="bg-yellow-50/50">
                    <td className="py-4 px-4 font-medium text-gray-900">Non-Clumping</td>
                    <td className="py-4 px-4 text-gray-700">Remove solids</td>
                    <td className="py-4 px-4 text-gray-700">2-3 days</td>
                    <td className="py-4 px-4 text-yellow-700 font-medium">3-5 days</td>
                  </tr>
                  <tr>
                    <td className="py-4 px-4 font-medium text-gray-900">Natural (Corn/Wheat)</td>
                    <td className="py-4 px-4 text-gray-700">Daily</td>
                    <td className="py-4 px-4 text-gray-700">1 week</td>
                    <td className="py-4 px-4 text-green-700 font-medium">10-14 days</td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            <div className="mt-6 p-4 bg-blue-50 rounded-lg border border-blue-200">
              <h3 className="font-semibold text-blue-900 mb-2">Multi-Cat Adjustment</h3>
