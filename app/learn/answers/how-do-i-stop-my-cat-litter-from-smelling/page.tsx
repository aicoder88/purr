...
export const metadata: Metadata = {
  ...
  description: 'Stop cat litter odor permanently with these science-backed methods. Learn why most deodorizers fail and how activated carbon eliminates ammonia at the molecular level.',
  keywords: [
