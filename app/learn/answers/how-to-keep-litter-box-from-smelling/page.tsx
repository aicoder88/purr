...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Keep Litter Box From Smelling: Daily Routine | Purrify',
    description: 'Simple daily and weekly routines to keep your litter box fresh. Morning and evening tasks that prevent odor buildup.',
    url: `${SITE_URL}/learn/answers/how-to-keep-litter-box-from-smelling`,
    type: 'article',
    siteName: SITE_NAME,
    locale: 'en_CA',
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Keep Litter Box From Smelling',
      },
    ],
  },
};
        ...
        <div className="prose prose-lg max-w-none dark:prose-invert">
          ...
          <div className="border-t border-gray-200 dark:border-gray-700 pt-8">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="bg-orange-50 dark:bg-orange-900/20 rounded-xl p-6 border border-orange-200 dark:border-orange-800 dark:border-orange-700">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="font-bold text-orange-900 dark:text-orange-100">Daily Tasks</h3>
                  <span className="text-sm text-orange-600 dark:text-orange-400 ml-auto">~4 mins/day</span>
                </div>
                <ul className="space-y-3">
                  {[
                    ...
                    <li key={i} className="flex justify-between items-center py-2 border-b border-orange-200 dark:border-orange-800 dark:border-orange-700/50 last:border-0">
                      <span className="text-orange-900 dark:text-orange-100">{item.task}</span>
              ...
              <div className="bg-blue-50 dark:bg-blue-900/20 rounded-xl p-6 border border-blue-200 dark:border-blue-800">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="font-bold text-blue-900 dark:text-blue-100">Weekly Tasks</h3>
                  <span className="text-sm text-blue-600 dark:text-blue-400 ml-auto">~15 mins/week</span>
                </div>
                <ul className="space-y-3">
                  {[
                    ...
                    <li key={i} className="py-2 border-b border-blue-200 dark:border-blue-800/50 last:border-0">
                      <span className="text-blue-900 dark:text-blue-100 font-medium">{item.task}</span>
                      <p className="text-xs text-blue-600 dark:text-blue-400">{item.detail}</p>
                    </li>
                  ))}
                </ul>
              </div>
            ...
            <div className="mt-6 p-4 bg-gray-100 dark:bg-gray-800 rounded-lg">
              <h4 className="font-semibold text-gray-900 dark:text-white mb-2">The 2-3 Inch Rule</h4>
