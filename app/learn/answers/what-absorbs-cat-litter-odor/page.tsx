...
const relatedQuestions = [
  ...
  { slug: 'what-eliminates-cat-litter-odor', question: 'What neutralizes cat litter smell?' },
          ...
          <div className="border-t border-gray-200 dark:border-gray-700 pt-8">
            ...
            <div className="space-y-3">
              <div className="flex items-start gap-4 p-4 bg-green-50 dark:bg-green-900/20 rounded-lg">
                ...
                <div>
                  <h3 className="font-semibold text-green-800 dark:text-green-300">Activated Carbon</h3>
                  <p className="text-green-700 dark:text-green-400 text-sm">1000+ m²/g surface area. Binds ammonia permanently. Most effective option.</p>
                </div>
              </div>
              <div className="flex items-start gap-4 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                <span className="text-2xl">🥈</span>
                <div>
                  <h3 className="font-semibold text-blue-800 dark:text-blue-300">Zeolite</h3>
                  <p className="text-blue-700 dark:text-blue-400 text-sm">Natural mineral. Moderate absorption. Good for moisture and some odors.</p>
                </div>
              </div>
              <div className="flex items-start gap-4 p-4 bg-yellow-50 dark:bg-yellow-900/20 rounded-lg">
                <span className="text-2xl">🥉</span>
                <div>
                  <h3 className="font-semibold text-yellow-800 dark:text-yellow-300">Baking Soda</h3>
                  <p className="text-yellow-700 dark:text-yellow-400 text-sm">Limited effect. Mostly masks odor. Not effective on ammonia.</p>
                </div>
              </div>
            </div>
