      ...
      <article className="max-w-3xl mx-auto px-4 py-12">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <div className="border-t border-gray-200 pt-8">
            ...
            <div className="space-y-4">
              ...
              <div className="p-5 bg-green-50 rounded-xl border border-green-200">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div>
                    <h3 className="font-bold text-green-900">1-2 Cats, Daily Scooping</h3>
                    <p className="text-sm text-green-700">Best overall choice</p>
                  </div>
                </div>
                <p className="text-green-800 ml-13">
              ...
              <div className="p-5 bg-blue-50 rounded-xl border border-blue-200">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div>
                    <h3 className="font-bold text-blue-900">3+ Cats (Multi-Cat)</h3>
                    <p className="text-sm text-blue-700">Heavy odor load</p>
                  </div>
                </div>
                <p className="text-blue-800 ml-13">
              ...
              <div className="p-5 bg-orange-50 rounded-xl border border-orange-200">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div>
                    <h3 className="font-bold text-orange-900">Small Apartment</h3>
                    <p className="text-sm text-orange-700">Limited ventilation</p>
                  </div>
                </div>
                <p className="text-orange-800 ml-13">
              ...
              <div className="p-5 bg-teal-50 rounded-xl border border-teal-200">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div>
                    <h3 className="font-bold text-teal-900">Eco-Conscious</h3>
                    <p className="text-sm text-teal-700">Natural preference</p>
                  </div>
                </div>
            ...
            {/* Key insight */}
            <div className="mt-6 p-4 bg-[#1E4D6B] rounded-lg text-white">
            ...
            <div className="grid sm:grid-cols-2 gap-3">
              <div className="p-3 bg-red-50 rounded-lg">
                <p className="text-red-800 text-sm"><strong>❌ Scented litters</strong> — Mask odor, irritate cats</p>
              </div>
              <div className="p-3 bg-red-50 rounded-lg">
                <p className="text-red-800 text-sm"><strong>❌ Baking soda only</strong> — Does not work on ammonia</p>
              </div>
            </div>
