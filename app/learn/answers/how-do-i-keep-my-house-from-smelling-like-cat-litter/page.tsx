...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://www.purrify.ca/learn/answers/how-do-i-keep-my-house-from-smelling-like-cat-litter/'
  },
  openGraph: {
    title: 'Stop House Smelling Like Cat Litter | Purrify',
  ...
  return (
    <main className="min-h-screen bg-white dark:bg-gray-900">
      ...
      <article className="max-w-3xl mx-auto px-4 py-12">
        <div className="mb-8">
          <span className="inline-block px-3 py-1 bg-teal-100 dark:bg-teal-900/30 text-teal-700 dark:text-teal-300 text-sm font-medium rounded-full mb-4">
            Home Care
          </span>
