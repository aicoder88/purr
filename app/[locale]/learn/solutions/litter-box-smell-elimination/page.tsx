...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
    ...
    const canonicalPath = locale === 'en'
        ? `${SITE_URL}/learn/solutions/litter-box-smell-elimination/`
        : `${SITE_URL}/${locale}/learn/solutions/litter-box-smell-elimination/`;
...
export default async function LitterBoxSmellEliminationPage({ params }: PageProps) {
    const { locale } = await params;
