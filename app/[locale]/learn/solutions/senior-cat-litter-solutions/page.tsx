...
const heroImage = 'https://www.purrify.ca/images/senior-cat-hero.png';
...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
    ...
    const canonicalPath = locale === 'en'
        ? `${SITE_URL}/learn/solutions/senior-cat-litter-solutions/`
        : `${SITE_URL}/${locale}/learn/solutions/senior-cat-litter-solutions/`;
...
export default async function SeniorCatLitterSolutionsPage({ params }: PageProps) {
    const { locale } = await params;
