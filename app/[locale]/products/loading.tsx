    ...
    <div className="min-h-screen bg-white px-4 py-10 dark:bg-gray-900">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mb-12 space-y-4 text-center">
          <div className="mx-auto h-10 w-48 animate-pulse rounded bg-gray-200 dark:bg-gray-700" />
          <div className="mx-auto h-5 w-80 max-w-full animate-pulse rounded bg-gray-200 dark:bg-gray-700" />
        </div>

        {/* Products Grid Skeleton */}
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
          {Array.from({ length: 3 }).map((_, i) => (
            <div key={i} className="space-y-4 rounded-lg border border-gray-200 p-6 dark:border-gray-700">
