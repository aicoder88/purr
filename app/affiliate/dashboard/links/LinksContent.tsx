...
function LinkCard({ link }: { link: LinkTemplate }) {
    ...
    return (
        <div className="bg-white bg-gray-800 rounded-lg border border-gray-200 border-gray-700 p-4 hover:shadow-md hover:shadow-gray-900/30 transition-shadow">
            ...
            <div className="flex items-center space-x-2">
                <div className="flex-1 bg-gray-100 bg-gray-700 rounded-lg px-3 py-2 overflow-hidden">
                    <code className="text-xs text-gray-600 text-gray-400 truncate block">
                        {link.url}
                    </code>
                </div>
                <button
    ...
    return (
        <div className="bg-white bg-gray-800 rounded-xl border border-gray-200 border-gray-700 p-6">
            <div className="flex items-center space-x-2 mb-4">
                <QrCode className="w-5 h-5 text-purple-600 text-purple-400" />
            ...
            <div className="flex justify-center">
                <div className="bg-white bg-gray-100 p-4 rounded-lg">
                        <Image
                        src={qrCodeUrl}
            ...
            {isLoading ? (
                <div className="space-y-6">
                    ...
                    <div className="bg-white bg-gray-800 rounded-xl border border-gray-200 border-gray-700 p-6 animate-pulse">
                        <div className="h-6 bg-gray-200 bg-gray-700 rounded w-48 mb-4" />
                        <div className="h-4 bg-gray-200 bg-gray-700 rounded w-64 mb-6" />
                ...
                <div className="space-y-8">
                    ...
                    <div className="bg-purple-50 bg-purple-900/20 border border-purple-200 border-purple-800 rounded-xl p-6">
                        <h3 className="text-lg font-semibold text-purple-900 text-purple-100 mb-3">
                            Tips for Sharing
                        </h3>
                        <ul className="space-y-2 text-sm text-purple-800 text-purple-200">
                            <li className="flex items-start">
                                <span className="w-1.5 h-1.5 bg-purple-600 bg-purple-400 rounded-full mt-2 mr-2 flex-shrink-0" />
                                <span>
