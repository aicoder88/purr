...
const productImages: ProductImage[] = [
    {
        ...
        url: '/optimized/products/60g-transparent.webp',
        previewUrl: '/optimized/products/60g-transparent.webp',
    },
    {
        id: 'product-120g',
        name: 'Purrify 120g Family Pack',
        description: 'Product image for multi-cat households',
        url: '/optimized/products/140g-transparent.webp',
        previewUrl: '/optimized/products/140g-transparent.webp',
    },
    {
        id: 'product-trial',
        name: 'Purrify Trial Size',
        description: 'Free trial product image',
        url: '/optimized/products/samplebag.webp',
        previewUrl: '/optimized/products/samplebag.webp',
    },
    {
        id: 'product-lifestyle',
        name: 'Lifestyle Shot',
        description: 'Cat with Purrify product',
        url: '/optimized/blog/cat-favorite-litter.webp',
        previewUrl: '/optimized/blog/cat-favorite-litter.webp',
    },
];
