      ...
      <div className="mx-auto max-w-4xl space-y-6">
        ...
        <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
          {Array.from({ length: 9 }).map((_, i) => (
            <div
              key={i}
              className="flex items-center justify-between rounded-lg border border-gray-200 bg-white p-4 border-gray-700 bg-gray-800"
            >
              <div className="h-5 w-24 animate-pulse rounded bg-gray-200 bg-gray-700" />
              <div className="flex gap-2">
                <div className="h-6 w-6 animate-pulse rounded bg-gray-200 bg-gray-700" />
                <div className="h-6 w-6 animate-pulse rounded bg-gray-200 bg-gray-700" />
              </div>
            </div>
          ))}
