    ...
    <div className="min-h-[60vh] flex items-center justify-center p-6">
      <div className="w-full max-w-md rounded-lg border border-gray-200 bg-white p-6 text-center shadow-sm border-gray-700 bg-gray-800">
        ...
        <div className="flex justify-center mb-4">
          <div className="p-3 rounded-full bg-red-100 bg-red-900/30">
            <AlertCircle className="w-8 h-8 text-red-500 text-red-400" />
          </div>
        </div>
        ...
        {process.env.NODE_ENV === 'development' && (
          <details className="mt-4 text-left">
            <summary className="text-xs text-gray-500 text-gray-400 cursor-pointer py-2">
              Debug Details
            </summary>
