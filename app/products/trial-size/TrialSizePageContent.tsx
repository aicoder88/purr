  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-gray-50 bg-gray-900">
        ...
        {/* Top Banner */}
        <div className="bg-black text-white text-center py-2 text-sm font-bold tracking-widest uppercase bg-black/90 text-gray-100">
          FREE TRIAL - LIMITED TIME
        </div>

        {/* Hero Section */}
        <section className="relative overflow-hidden bg-white bg-gray-900">
          <div className="absolute inset-0 z-0">
            <Image
              src="/optimized/marketing/cat-clean-home.avif"
              alt="Clean modern apartment with a subtle litter box"
              fill
              className="object-cover opacity-30 opacity-20 mix-blend-multiply mix-blend-screen"
              priority
            />
            <div className="absolute inset-0 bg-gradient-to-t from-white via-white/80 to-transparent from-gray-900 via-gray-900/80"></div>
          </div>

          <Container className="relative z-10 pt-20 pb-16 md:pt-32 md:pb-24 max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-6xl font-black text-gray-900 text-white mb-8 tracking-tight leading-tight font-serif">
              The Litter Box Problem<br />Every Cat Owner Has.<br />
              <span className="text-gray-500 text-gray-400">And Almost Nobody Talks About.</span>
            </h1>

            <div className="prose prose-lg md:prose-xl prose-invert mx-auto text-gray-800 text-gray-200 mb-12">
            ...
            <a href={checkoutUrl} target="_blank" rel="noopener noreferrer" onClick={handleBuyClick} className="inline-block">
              <Button
                size="lg"
                className="bg-black hover:bg-gray-800 text-white bg-white text-black hover:bg-gray-200 font-bold py-6 px-12 text-lg rounded-none shadow-xl transform hover:-translate-y-1 transition-all uppercase tracking-widest"
              >
                Get My Free Trial
              </Button>
            </a>
        ...
        <section className="bg-gray-100 bg-gray-950 py-20">
          <Container className="max-w-5xl mx-auto">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div className="order-1 md:order-2 space-y-6">
                <p className="text-sm font-bold tracking-widest uppercase text-gray-500 text-gray-400">The Science, Simply Put</p>
                <h2 className="text-3xl md:text-4xl font-serif font-black text-gray-900 text-white leading-tight">
                  This Isn&apos;t a Cover-Up.<br />It&apos;s a Filter.
                </h2>
                <div className="space-y-4 text-lg text-gray-700 text-gray-300">
                  ...
                  <p className="font-bold text-black text-white text-xl">Not masked. Not perfumed over. Removed.</p>
          ...
          <Container className="max-w-5xl mx-auto text-center">
            <div className="relative w-full max-w-3xl mx-auto aspect-[16/9] mb-12">
              ...
              <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                <h3 className="text-4xl md:text-5xl font-black text-white text-gray-100 drop-shadow-2xl font-serif">Works with any litter.<br />Any cat. Any box.</h3>
              </div>
            </div>
          </Container>
        </section>
        ...
        {/* Social Proof */}
        <section className="py-24 bg-gray-50 bg-gray-950 border-y border-gray-200 border-gray-800">
          <Container className="max-w-4xl mx-auto">
            <div className="text-center mb-16">
              <p className="text-sm font-bold tracking-widest uppercase text-gray-500 text-gray-400 mb-4">What People Are Saying</p>
              <h2 className="text-3xl md:text-4xl font-serif font-black text-gray-900 text-white">
            ...
            <div className="space-y-16">
              {/* Testimonial 1 */}
              <div className="flex flex-col md:flex-row gap-8 items-center bg-white bg-gray-900 p-8 rounded-2xl shadow-lg">
                <div className="flex-1 space-y-4">
                  <div className="flex text-yellow-500 text-yellow-400">
                    {[...Array(5)].map((_, i) => <Star key={i} className="w-5 h-5 fill-current" />)}
                  </div>
                  <p className="text-xl md:text-2xl font-medium text-gray-900 text-white leading-relaxed font-serif italic">
                  ...
                  <div>
                    <p className="font-bold text-gray-900 text-white">Jessica K., Vancouver</p>
                    <p className="text-sm text-gray-500 text-gray-400">Trial customer - now monthly subscriber</p>
                  </div>
                </div>
              ...
              {/* Testimonial 2 */}
              <div className="flex flex-col md:flex-row-reverse gap-8 items-center bg-white bg-gray-900 p-8 rounded-2xl shadow-lg">
                <div className="flex-1 space-y-4">
                  <div className="flex text-yellow-500 text-yellow-400">
                    {[...Array(5)].map((_, i) => <Star key={i} className="w-5 h-5 fill-current" />)}
                  </div>
                  ...
                  <div>
                    <p className="font-bold text-gray-900 text-white">Sarah M., Toronto</p>
                    <p className="text-sm text-gray-500 text-gray-400">Upgraded to full-size within 48 hours</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-16">
              <div className="bg-black text-white bg-white text-black p-8 rounded-xl text-center shadow-xl">
        ...
        <section className="py-24 bg-white bg-gray-900">
          <Container className="max-w-4xl mx-auto">
            <div className="text-center mb-16">
              <p className="text-sm font-bold tracking-widest uppercase text-gray-500 text-gray-400 mb-4">Why Nothing Else Works</p>
              <h2 className="text-3xl md:text-4xl font-serif font-black text-gray-900 text-white mb-6">
                You&apos;ve Already Tried Everything.<br />Here&apos;s Why It Kept Failing.
              </h2>
            </div>

            <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
              <div className="space-y-6 text-lg text-gray-700 text-gray-300">
                <p><strong className="text-black text-white font-serif">Scented cat litter</strong> doesn&apos;t eliminate odor. It competes with it. The result is something arguably worse - a synthetic floral smell layered over ammonia. Your guests notice both.</p>
                <p><strong className="text-black text-white font-serif">Baking soda</strong> - a standard recommendation for cat litter odor control - has a surface area too small to trap ammonia effectively. It helps for a few hours, then it&apos;s done.</p>
                <p><strong className="text-black text-white font-serif">Air fresheners</strong> and plug-ins are the equivalent of cleaning your home by hiding things in closets. The smell is still there. You&apos;ve just diluted it temporarily.</p>
              </div>
              <div className="space-y-6 text-lg text-gray-700 text-gray-300 bg-gray-50 bg-gray-950 p-8 rounded-2xl border border-gray-100 border-gray-800 shadow-lg">
                <h3 className="text-2xl font-black font-serif text-black text-white mb-4">The problem isn&apos;t effort.<br />It&apos;s mechanism.</h3>
                ...
                <p className="font-bold text-black text-white underline decoration-gray-300 decoration-gray-700 underline-offset-4">No other cat litter additive in Canada uses the same grade of carbon.</p>
              </div>
            </div>

            {/* Diagram Comparison Placeholder mapping to existing images */}
            <div className="space-y-4">
              <div className="relative w-full aspect-video md:aspect-[16/9] rounded-2xl overflow-hidden shadow-xl border border-gray-200 border-gray-800 bg-white bg-gray-900">
                <Image
              ...
              <p className="text-center text-sm text-gray-500 text-gray-400 font-medium px-4">
        ...
        {/* The Offer Section */}
        <section className="py-24 bg-gray-50 bg-gray-950 border-t border-gray-200 border-gray-800">
          <Container className="max-w-5xl mx-auto">
            <div className="grid md:grid-cols-2 gap-16 items-center">

              <div className="order-2 md:order-1 space-y-8">
                <div>
                  <p className="text-sm font-bold tracking-widest uppercase text-gray-500 text-gray-400 mb-4">The Offer</p>
                  <h2 className="text-4xl md:text-5xl font-serif font-black text-gray-900 text-white leading-tight">
                ...
                <div className="space-y-4 text-lg text-gray-700 text-gray-300">
                  ...
                  <p className="font-bold text-xl text-black text-white bg-white bg-gray-900 p-4 border-l-4 border-black border-white rounded-r-lg shadow-sm">Yours free. You cover the {trialPrice} shipping to anywhere in Canada.</p>
                  ...
                  <div className="bg-black text-white bg-white text-black p-6 rounded-xl shadow-lg mt-6">
                    <h4 className="font-bold text-xl mb-2 flex items-center gap-2"><Lock className="w-5 h-5" /> The 30-Day Guarantee</h4>
                    <p className="text-base text-gray-300 text-gray-700 font-medium">If you don&apos;t love it, you pay nothing. Full refund. No questions asked. Keep the product - we can&apos;t resell it anyway. You have 30 days. Use them.</p>
                  </div>
                </div>
              </div>

              <div className="order-1 md:order-2">
                <div className="bg-white bg-gray-900 rounded-3xl p-8 shadow-2xl relative border border-gray-100 border-gray-800 text-center">
                  <div className="absolute top-6 right-6 bg-black text-white bg-white text-black font-bold px-4 py-2 rounded-full transform rotate-3 shadow-xl z-20 font-serif">
                    FREE
                  </div>
                  ...
                  <div className="flex justify-center gap-4 text-xs font-bold uppercase tracking-wider text-gray-500 text-gray-400 mb-8 flex-wrap">
                    <span>Ships 24H</span>
                    <span>•</span>
                  ...
                  <a href={checkoutUrl} target="_blank" rel="noopener noreferrer" onClick={handleBuyClick} className="block w-full">
                    <Button
                      size="lg"
                      className="w-full bg-black hover:bg-gray-800 text-white bg-white text-black hover:bg-gray-200 font-bold py-8 text-lg md:text-xl rounded-xl shadow-xl transform hover:-translate-y-1 transition-all flex flex-col items-center justify-center h-auto"
                    >
                  ...
                  <p className="mt-4 text-sm text-gray-500 text-gray-400 font-medium">$14.99 value - FREE for a limited time. Limit one.</p>

                  <ul className="mt-6 space-y-2 text-sm text-left font-medium text-gray-700 text-gray-300">
                  ...
                  <div className="mt-8 pt-6 border-t border-gray-100 border-gray-800">
                    <div className="flex justify-center flex-wrap gap-4 text-sm font-semibold text-gray-400 text-gray-500 uppercase">
                      <span>Visa</span>
                ...
                <div className="mt-8 flex justify-center items-center gap-8 opacity-60 grayscale hover:grayscale-0 transition-all duration-500">
                  <Image src="/optimized/logos/chico-logo.svg" alt="Chico" width={100} height={32} className="h-8 w-auto invert" />
        ...
        {/* The Close */}
        <section className="py-24 bg-white bg-gray-900 border-t border-gray-200 border-gray-800">
          <Container className="max-w-3xl mx-auto text-center">
            <p className="text-sm font-bold tracking-widest uppercase text-gray-500 text-gray-400 mb-4">The Two Paths</p>
            <h2 className="text-4xl font-serif font-black text-gray-900 text-white mb-8">
              This Is the Last Time You&apos;ll Read About This.
            </h2>

            <div className="prose prose-lg prose-invert mx-auto text-gray-700 text-gray-300 mb-12">
              <p>You can close this tab. Light a candle. Spray something. Hope for the best before your next guest arrives.</p>
              <p className="font-bold text-xl text-black text-white my-8">Or you can spend {trialPrice} - less than a coffee - and find out why 87% of the people who tried this never went back to their old routine.</p>
            ...
            <a href={checkoutUrl} target="_blank" rel="noopener noreferrer" onClick={handleBuyClick} className="inline-block">
              <Button
                size="lg"
                className="bg-black hover:bg-gray-800 text-white bg-white text-black hover:bg-gray-200 font-bold py-6 px-16 text-lg rounded-none shadow-xl transform hover:-translate-y-1 transition-all uppercase tracking-widest"
              >
                Claim My Free Trial
              </Button>
            </a>
            <p className="mt-4 text-sm text-gray-500 text-gray-400 font-medium max-w-sm mx-auto">{trialPrice} shipping anywhere in Canada. Limited quantities. Limit one per customer.</p>
          </Container>
        </section>
        ...
        <section className="relative h-[60vh] min-h-[400px]">
          ...
          <Container className="absolute inset-0 flex flex-col justify-end pb-16 z-10 text-white text-gray-100 text-center md:text-left max-w-5xl mx-auto">
            <div className="max-w-2xl bg-black/40 backdrop-blur-md p-8 rounded-2xl border border-white/10">
              <h3 className="font-serif font-black text-2xl mb-4 text-white text-gray-100">We&apos;re Purrify.</h3>
              <p className="text-lg font-medium text-gray-200 text-gray-300 mb-2">A Canadian company obsessed with one thing: making sure your home smells exactly the way you want it to.</p>
              <p className="text-sm text-gray-400 text-gray-500">Water-filter grade activated carbon. No perfumes. No chemicals. No compromises.</p>
            </div>
          </Container>
        </section>

        {/* PS Section */}
        <section className="py-16 bg-gray-50 bg-gray-950">
          <Container className="max-w-3xl mx-auto">
            <div className="bg-white bg-gray-900 border-l-4 border-black border-white p-8 shadow-lg text-gray-700 text-gray-300 italic">
              <strong className="text-black text-white font-serif text-lg not-italic">P.S.</strong> - Ammonia from cat urine doesn&apos;t just smell. At sustained exposure levels, it irritates airways and is particularly hard on cats with respiratory sensitivities. Eliminating it isn&apos;t just about what your guests think. It&apos;s about the air you and your cat breathe every day. Purrify removes it at the source. <a href={checkoutUrl} className="font-bold text-black text-white underline underline-offset-4 decoration-2">Your first bag is free.</a>
            </div>
          </Container>
        </section>
