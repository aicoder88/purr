    ...
    <section className="py-16 bg-white bg-gray-800">
      <Container>
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {benefits.map((benefit, index) => (
              <div key={index} className="flex items-start space-x-4">
                <div className="flex-shrink-0 w-10 h-10 rounded-full bg-green-100 bg-green-900 flex items-center justify-center">
                  <CheckCircle className="w-5 h-5 text-green-600 text-green-400" />
                </div>
                <div>
                  <h3 className="font-bold text-gray-900 text-gray-100 mb-1">
                    {benefit.title}
                  </h3>
          ...
          <p className="text-center mt-12 text-lg text-gray-700 text-gray-300">
            {locale === 'fr'
