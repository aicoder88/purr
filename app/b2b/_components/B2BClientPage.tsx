            ...
            >
              ...
              <Link
                ...
                className={`block w-full text-center py-3 rounded-lg font-semibold transition-colors ${
                  tier.highlighted
                    ? 'bg-blue-600 dark:bg-blue-600 text-white dark:text-white hover:bg-blue-700 dark:hover:bg-blue-700'
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="text-center">
            <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-700 rounded-lg p-6 mb-4">
              ...
              <p className="text-sm text-gray-700 dark:text-gray-300">
                {locale === 'fr'
                  ? 'Le plus populaire - meilleure valeur'
          ...
          <div className="text-center">
            <div className="bg-white dark:bg-gray-700 rounded-lg p-6 mb-4">
              ...
              <p className="text-sm text-gray-700 dark:text-gray-300">
                {locale === 'fr'
                  ? 'Économique pour multi-chats'
                  : 'Economical for multi-cat homes'}
              </p>
            </div>
          </div>
        </div>
              ...
              <form className="grid gap-6 md:grid-cols-2">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="0-1">
                      0-1 {locale === 'fr' ? 'ans' : 'years'}
                    </option>
                    <option value="2-5">
                      2-5 {locale === 'fr' ? 'ans' : 'years'}
                    </option>
                    <option value="6-10">
                      6-10 {locale === 'fr' ? 'ans' : 'years'}
                    </option>
                ...
                <div className="md:col-span-2">
                  <button
                    ...
                    className="w-full bg-blue-600 dark:bg-blue-600 text-white dark:text-white px-8 py-4 rounded-lg font-semibold text-lg hover:bg-blue-700 dark:hover:bg-blue-700 transition-colors"
                  >
                    {locale === 'fr'
