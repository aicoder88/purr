          ...
          <Container>
            <div className="max-w-6xl mx-auto">
              ...
              <div className="flex flex-col">
                {/* Reviews Grid */}
                <div className={`cv-auto cis-960 ${experimentCopy.proofOrder === 'trust-first' ? 'order-2' : 'order-1'}`}>
                ...
                {/* Trust Indicators */}
                <div className={`bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-700 rounded-xl p-8 mb-16 cv-auto cis-480 ${experimentCopy.proofOrder === 'trust-first' ? 'order-1' : 'order-2'}`}>
