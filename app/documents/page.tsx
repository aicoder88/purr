  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gray-50 bg-gray-900">
        {/* Header */}
        <div className="bg-gradient-to-r from-blue-600 to-blue-500 from-blue-700 to-blue-600 text-white text-gray-100 py-16">
          <div className="container mx-auto px-4 text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-4">
              {locale === 'fr' ? '📚 Centre de Ressources Purrify' : '📚 Purrify Resource Center'}
            </h1>
            <p className="text-xl text-blue-100 text-blue-100">
              {locale === 'fr'
        ...
        <div className="container mx-auto px-4 py-12">
          {/* Search and Filters */}
          <div className="bg-white bg-gray-800 rounded-lg shadow-md p-6 mb-8">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {/* Search */}
              <div className="relative">
                <Search className="absolute left-3 top-1/2 transform -translate-y-1/2 h-5 w-5 text-gray-400 text-gray-500" />
                <input
                  type="text"
                  placeholder={locale === 'fr' ? 'Rechercher...' : 'Search...'}
                  value={searchTerm}
                  onChange={(e) => setSearchTerm(e.target.value)}
                  className="w-full pl-10 pr-4 py-2 border border-gray-300 border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:ring-blue-400 focus:border-transparent bg-white bg-gray-700 text-gray-900 text-gray-100"
                />
              </div>
              {/* Category Filter */}
              <select
                ...
                className="px-4 py-2 border border-gray-300 border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:ring-blue-400 focus:border-transparent bg-white bg-gray-700 text-gray-900 text-gray-100"
              >
                {categories.map(cat => (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredResources.map(resource => (
              <div key={resource.id} className="bg-white bg-gray-800 rounded-lg shadow-md hover:shadow-lg transition-shadow overflow-hidden">
                <div className="p-6">
                  <div className="flex items-start justify-between mb-4">
                    <div className="p-3 bg-blue-100 bg-blue-900 rounded-lg">
                      {resource.icon}
                    </div>
                    <span className="px-3 py-1 text-xs font-semibold bg-gray-100 bg-gray-700 text-gray-800 text-gray-200 rounded-full">
                      {resource.category.charAt(0).toUpperCase() + resource.category.slice(1)}
                    </span>
                  </div>
                  <h3 className="text-lg font-bold text-gray-900 text-gray-100 mb-2">
                  ...
                  <div className="flex flex-wrap gap-2 mb-4">
                    {resource.languages.map(lang => (
                      <span key={lang} className="px-2 py-1 text-xs bg-blue-100 bg-blue-900 text-blue-800 text-blue-200 rounded">
                  ...
                  <a
                    ...
                    className="inline-flex items-center gap-2 px-4 py-2 bg-blue-600 hover:bg-blue-700 bg-blue-500 hover:bg-blue-600 text-white text-gray-100 rounded-lg transition-colors font-semibold"
                  >
        ...
        {/* Footer */}
        <div className="bg-gray-800 bg-gray-950 text-white text-gray-100 py-8 mt-12">
          <div className="container mx-auto px-4 text-center">
            <p className="font-bold mb-2">
              ...
              <a href={`mailto:${CONTACT_INFO.email}`} className="text-blue-400 hover:text-blue-300 text-blue-400 hover:text-blue-300">{CONTACT_INFO.email}</a>
              {' | '}
              <a href="tel:1-450-663-6773" className="text-blue-400 hover:text-blue-300 text-blue-400 hover:text-blue-300">1-450-663-6773</a>
            </p>
          </div>
        </div>
      </div>
