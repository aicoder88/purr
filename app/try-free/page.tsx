...
export default function TryFreePage() {
  ...
  const pageTitle = 'FREE Purrify Trial | Just Pay Shipping | Eliminates Odors';
  const pageDescription = 'FREE Purrify Trial | Just Pay Shipping | Eliminates cat litter smell instantly with water-filter grade carbon. ★ 4.8 rating. Ships USA & Canada.';
