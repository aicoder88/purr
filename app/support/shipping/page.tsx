...
import { Truck, Clock, MapPin, Package, Globe, AlertCircle, CheckCircle2, RotateCcw, Shield } from 'lucide-react';
          ...
          <Container>
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
                Fast, reliable shipping to your door. 30-day money-back guarantee on every order — no questions asked.
              </p>
            </div>
          </Container>
        </section>
        ...
        <section className="py-16">
          <Container>
            ...
            <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
              <div className="bg-gradient-to-br from-gray-50 to-white dark:from-gray-800 dark:to-gray-900 rounded-2xl p-8 shadow-lg border border-gray-100 dark:border-gray-700 text-center">
                ...
                <h3 className="font-heading text-xl font-bold text-gray-900 dark:text-white mb-3">30-Day Money-Back</h3>
                <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed">
                  Not satisfied? Get a full refund within 30 days of purchase — no questions asked. We stand behind our product completely.
                </p>
              </div>
              <div className="bg-gradient-to-br from-gray-50 to-white dark:from-gray-800 dark:to-gray-900 rounded-2xl p-8 shadow-lg border border-gray-100 dark:border-gray-700 text-center">
                ...
                <h3 className="font-heading text-xl font-bold text-gray-900 dark:text-white mb-3">Free Returns</h3>
                <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed">
                  Return shipping is on us. Simply contact our support team and we will arrange a prepaid return label for you.
                </p>
              </div>
              <div className="bg-gradient-to-br from-gray-50 to-white dark:from-gray-800 dark:to-gray-900 rounded-2xl p-8 shadow-lg border border-gray-100 dark:border-gray-700 text-center">
                <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-purple-100 dark:bg-purple-900/30 mb-5">
                  <Truck className="w-8 h-8 text-purple-600 dark:text-purple-400" />
                </div>
                <h3 className="font-heading text-xl font-bold text-gray-900 dark:text-white mb-3">2–5 Day Delivery</h3>
                <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed">
                  Most Canadian orders arrive within 2–5 business days. US orders typically take 5–10 business days.
                </p>
              </div>
            </div>
            <div className="mt-10 max-w-3xl mx-auto bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-2xl p-6 text-center">
              <p className="text-green-800 dark:text-green-200 text-sm leading-relaxed">
                <strong>How to start a return:</strong> Email{' '}
                <a href={`mailto:${CONTACT_INFO.email}`} className="font-semibold underline">
                  {CONTACT_INFO.email}
                </a>{' '}
                within 30 days with your order number. We will process your refund within 3–5 business days.
              </p>
            </div>
          </Container>
        </section>
