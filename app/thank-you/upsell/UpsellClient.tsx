...
export default function UpsellClient({ initialEmail, sessionId }: UpsellClientProps) {
  ...
  useEffect(() => {
    ...
    if (initialEmail) {
      ...
      sessionStorage.setItem('upsell_customer_email', initialEmail);
    } else {
  ...
  }, [locale, customerEmail, sessionId, initialEmail]);
  ...
  return (
    <div className="max-w-4xl mx-auto py-8 md:py-16">
      ...
      <div className="text-center mb-8">
        <div className="inline-flex items-center justify-center bg-gradient-to-r from-[#FF3131] to-[#FF3131]/80 from-[#FF5050] to-[#FF5050]/80 text-white text-gray-100 px-6 py-3 rounded-full text-lg md:text-xl font-bold mb-4 shadow-lg">
        ...
        <h1 className="font-heading text-3xl md:text-5xl font-bold mb-4 text-gray-900 text-gray-50">
          {t('upsell.headline') || 'Wait! One-Time Exclusive Offer'}
        </h1>
        <p className="text-xl md:text-2xl text-gray-700 text-gray-300">
          {t('upsell.subheadline') || 'Add autoship to your order and save 25%'}
        </p>
      </div>

      {/* Product Showcase */}
      <div className="bg-gradient-to-br from-white via-gray-50 to-white from-gray-800 via-gray-900 to-gray-800 rounded-2xl shadow-2xl p-8 md:p-12 mb-8 border-2 border-[#5B2EFF] border-[#3694FF]">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center mb-8">
          ...
          <div className="relative">
            ...
            <div className="relative bg-white bg-gray-700 rounded-2xl p-6 shadow-xl">
              <Image
              ...
              />
              <div className="absolute top-2 right-2 bg-[#03E46A] bg-[#04D162] text-gray-900 text-gray-900 px-3 py-1 rounded-full text-sm font-bold">
          ...
          <div className="space-y-6">
            <div>
              <h2 className="font-heading text-2xl md:text-3xl font-bold mb-3 text-gray-900 text-gray-50">
                {t('upsell.productTitle') || 'Purrify 50g Autoship'}
              </h2>
              <p className="text-lg text-gray-600 text-gray-300 mb-4">
                {t('upsell.productSubtitle') || '3-Month Supply (3 × 50g bags)'}
              </p>

              <div className="space-y-3">
                <div className="flex items-baseline gap-3">
                  <span className="text-4xl font-bold text-[#5B2EFF] text-[#3694FF]">
                    {standardAutoshipPrice}
                  </span>
                  <span className="text-2xl text-gray-400 text-gray-500 line-through">
                    {originalPrice}
                  </span>
                </div>
                <div className="inline-flex items-center bg-[#03E46A]/10 bg-[#04D162]/20 text-[#03E46A] text-[#04D162] px-4 py-2 rounded-full text-sm font-semibold">
            ...
            <div className="space-y-3">
              {[
                ...
                <div key={index} className="flex items-start gap-3">
                  <Check className="w-6 h-6 text-[#03E46A] text-[#04D162] flex-shrink-0 mt-0.5" />
                  <span className="text-gray-700 text-gray-300">{benefit}</span>
                </div>
              ))}
            </div>
          </div>
        ...
        <div className="space-y-4">
          <Button
            ...
            size="lg"
            className="w-full bg-gradient-to-r from-[#FF3131] to-[#FF3131]/80 hover:from-[#FF3131]/90 hover:to-[#FF3131] disabled:from-gray-400 disabled:to-gray-500 text-white text-gray-100 font-bold py-6 text-xl shadow-lg hover:shadow-xl transition-all duration-300"
          >
          ...
          <button
            ...
            disabled={isLoading}
            className="w-full text-gray-600 text-gray-400 hover:text-gray-900 hover:text-gray-200 font-medium py-3 transition-colors"
          >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div className="bg-white bg-gray-800 rounded-xl p-6 shadow-lg text-center">
          <Zap className="w-12 h-12 text-[#5B2EFF] text-[#3694FF] mx-auto mb-3" />
        ...
        <div className="bg-white bg-gray-800 rounded-xl p-6 shadow-lg text-center">
          <Shield className="w-12 h-12 text-[#03E46A] text-[#04D162] mx-auto mb-3" />
          <h3 className="font-heading text-xl font-bold mb-2 text-gray-900 text-gray-50">
        ...
        <div className="bg-white bg-gray-800 rounded-xl p-6 shadow-lg text-center">
          <Package className="w-12 h-12 text-[#FF3131] text-[#FF5050] mx-auto mb-3" />
          <h3 className="font-heading text-xl font-bold mb-2 text-gray-900 text-gray-50">
      ...
      {/* Testimonial */}
      <div className="bg-gradient-to-r from-[#5B2EFF]/10 to-[#FF3131]/10 from-[#3694FF]/10 to-[#FF5050]/10 rounded-xl p-8 mb-8 border border-gray-200 border-gray-700">
        <p className="text-lg md:text-xl text-gray-700 text-gray-300 mb-4 italic">
        ...
        <p className="font-semibold text-gray-900 text-gray-50">
          {t('upsell.testimonialAuthor') || '— Sarah M., Toronto'}
        </p>
      </div>

      {/* FAQ Section */}
      <div className="bg-white bg-gray-800 rounded-xl p-8 shadow-lg">
        <h3 className="font-heading text-2xl font-bold mb-6 text-center text-gray-900 text-gray-50">
          {t('upsell.faqTitle') || 'Common Questions'}
        </h3>
        <div className="space-y-4">
          <div>
            <h4 className="font-bold text-gray-900 text-gray-50 mb-2">
      ...
      <div className="mt-8 text-center">
        ...
        <Link
          ...
          className="text-sm text-gray-500 text-gray-400 hover:text-gray-700 hover:text-gray-300 underline"
        >
