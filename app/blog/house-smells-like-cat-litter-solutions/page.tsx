...
export const metadata: Metadata = {
  title: `7 Ways to Stop Cat Litter Smell | ${SITE_NAME}`,
  description: 'Stop embarrassing cat litter odors in 24 hours. 7 proven methods to eliminate litter box smell and keep your home fresh.',
  keywords: 'house smells like cat litter, control cat litter smell, cat litter urine smell, strong urine smell cat litter box, getting cat litter smell out of house, house smells like litter box',
  alternates: {
    canonical: 'https://www.purrify.ca/blog/house-smells-like-cat-litter-solutions',
  },
  openGraph: {
    title: 'Stop Being Embarrassed - 7 Ways to Eliminate Cat Litter Smell',
    description: 'No more apologizing to guests! These 7 proven methods eliminate embarrassing cat litter odors in 24 hours.',
    url: 'https://www.purrify.ca/blog/house-smells-like-cat-litter-solutions',
    images: [
      {
        url: 'https://www.purrify.ca/optimized/house-smells-cat-litter.webp',
        width: 1600,
        height: 1067,
      },
    ],
...
export default function HouseSmellsLikeCatLitterPage() {
  return (
    <>
      <script
