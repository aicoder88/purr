          ...
          <div className="w-fit mx-auto bg-white dark:bg-gray-900/80 backdrop-blur-md rounded-lg shadow-md border border-white/20 dark:border-gray-700/50 p-2">
            <div className="flex items-center space-x-3">
              ...
              <div className="flex space-x-1">
                {['overview', 'problem', 'solution', 'traction', 'financials', 'team', 'investment'].map((tab) => (
                  <div
                    key={tab}
          ...
          {activeTab === 'overview' && (
            <section className="space-y-12 relative z-10">
              ...
              <div className="text-center max-w-4xl mx-auto mb-16">
                ...
                <div className="bg-white dark:bg-gray-900/80 backdrop-blur-md rounded-2xl shadow-xl p-8 mb-12 border border-white/20 dark:border-gray-700/50 relative z-10">
          ...
          {activeTab === 'problem' && (
            <section className="space-y-8 relative z-10">
              <div className="bg-white dark:bg-gray-900/80 backdrop-blur-md rounded-2xl shadow-xl p-8 border border-white/20 dark:border-gray-700/50">
                ...
                <div className="grid lg:grid-cols-2 gap-8 mb-8">
                  <div>
                    ...
                    <div className="space-y-4">
                      <div className="bg-white dark:bg-gray-900/60 backdrop-blur-sm rounded-xl p-4 border border-[#FF3131]/30 border-l-4 border-l-[#FF3131]">
                ...
                <div className="bg-white dark:bg-gray-900/60 backdrop-blur-md rounded-xl p-6 border border-white/30 dark:border-gray-600/50">
