...
export default function ToolsPage() {
  return (
    <main className="bg-gray-50 dark:bg-gray-950 py-16 md:py-24">
      <Container>
          ...
          <div className="mt-10 grid gap-4 md:grid-cols-2">
            {TOOL_LINKS.map((tool) => (
              <Link
                key={tool.href}
                href={tool.href}
                className="block rounded-2xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 p-6 hover:border-green-300 dark:hover:border-green-700 transition-colors"
              >
                <h2 className="text-xl font-bold text-gray-900 dark:text-gray-100">{tool.title}</h2>
