...
export const es = {
  ...
  retailers: {
    ...
    hero: {
      ...
      mainDescription: "Unete a <strong class=\"text-[#5B2EFF] text-[#3694FF]\">21 minoristas establecidos</strong> vendiendo la solucion de olores de gatos #1 de Canada con <strong>margenes del 50%+</strong>",
