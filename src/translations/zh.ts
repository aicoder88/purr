...
export const zh = {
  ...
  ammonia: {
    meta: {
      ...
      description: "使用Purrify天然沸石配方消除猫砂盆氨气味。从源头控制异味30天以上。对猫咪安全。立即购买。"
    },
    breadcrumb: "氨气控制",
    hero: {
      headline: "氨气控制：从源头消除猫砂盆异味",
      subheadline: "Purrify天然沸石配方在氨气分子扩散到空气中之前将其捕获，让您的家保持清新30天以上。",
      cta: "立即购买",
      secondaryCta: "了解工作原理"
    },
    trust: {
    ...
    solution: {
      headline: "真正除臭的科学",
      description: "沸石是一种天然火山矿物，具有微孔结构，可以物理捕获氨气分子。与掩盖剂不同，沸石在分子水平上捕获异味并永久保持——您再也不会闻到它。"
    },
    benefits: {
      headline: "为什么猫主人选择Purrify",
      pillar1: {
        title: "天然科学",
        description: "100%天然沸石和活性炭。无化学物质、香料或可能伤害您猫咪的添加剂。"
      },
      pillar2: {
        title: "持久有效",
        description: "一次使用可保护30天以上，减少高达50%的猫砂更换次数，为您省钱。"
      },
      pillar3: {
        title: "安全温和",
    ...
    stats: {
      days: { value: "30+", label: "天清新" },
      savings: { value: "50%", label: "减少更换次数" },
    ...
    faq: {
      headline: "氨气控制常见问题",
      q1: "Purrify如何控制氨气？",
      a1: "Purrify使用天然沸石，一种具有数百万微孔的火山矿物，可以捕获氨气分子。与小苏打或掩盖异味的香料不同，沸石物理捕获并保持氨气，使其永远不会到达您的鼻子。",
      q2: "沸石对猫咪安全吗？",
      a2: "是的，沸石是100%天然和无毒的。它与优质净水器中使用的矿物质相同，几十年来一直安全地用于宠物周围。Purrify不含化学物质、香料或添加剂。",
      q3: "我应该使用多少Purrify？",
      a3: "只需在猫砂上撒上薄薄一层并混合即可。一袋50g可处理标准猫砂盆约30天。如果有多只猫，请使用我们的120g装。",
      q4: "它适用于所有类型的猫砂吗？",
      a4: "是的！Purrify适用于结团粘土、非结团、水晶、纸质、木质和玉米基猫砂。它可以增强任何猫砂的除臭效果。",
      q5: "Purrify与小苏打有什么不同？",
      a5: "小苏打只能暂时中和一些异味，需要不断重新使用。沸石永久性地物理捕获氨气分子，一次使用即可提供数周的保护。",
      q6: "它能消除现有的异味吗？",
      a6: "Purrify从您添加的那一刻起就开始吸收氨气。现有异味通常在24-48小时内随着沸石吸收而消失。",
      q7: "对幼猫安全吗？",
      a7: "绝对安全。Purrify对所有年龄的猫咪都安全。没有可能刺激幼猫或敏感猫咪的化学物质或香料。",
      q8: "一袋能用多久？",
      a8: "50g袋装可供一只猫使用约30天。120g袋装可供多猫家庭（2-3只猫）使用30天。大多数客户发现他们需要更换猫砂的频率降低了。"
    },
    cta: {
