...
export const fr = {
  ...
  retailers: {
    ...
    portal: {
      ...
      loginPage: {
        title: "Connexion au portail détaillant",
        subtitle: "Accédez à votre compte grossiste",
        ...
        toggleApply: "Pas encore de compte ? Demandez l'accès grossiste",
        toggleSignIn: "Vous avez déjà un compte ? Connectez-vous",
        register: {
          title: "Demander un compte grossiste",
          subtitle: "Rejoignez notre réseau de partenaires détaillants",
          businessSectionTitle: "Informations sur l'entreprise",
          shippingSectionTitle: "Adresse de livraison",
          securitySectionTitle: "Sécurité du compte",
          businessNameLabel: "Nom de l'entreprise",
          businessNamePlaceholder: "Votre animalerie inc.",
          ...
          taxIdLabel: "Numéro fiscal de l'entreprise (facultatif)",
          taxIdPlaceholder: "Numéro TPS/TVH",
          streetLabel: "Adresse",
          streetPlaceholder: "123 rue Principale",
          cityLabel: "Ville",
          cityPlaceholder: "Montréal",
          provinceLabel: "Province",
          provincePlaceholder: "Sélectionner",
          postalCodeLabel: "Code postal",
          postalCodePlaceholder: "H2Y 1C6",
          sameAsBilling: "L'adresse de facturation est la même que l'adresse de livraison",
          passwordLabel: "Mot de passe",
          passwordPlaceholder: "12+ caractères, maj./min., chiffre, spécial",
          confirmPasswordLabel: "Confirmer le mot de passe",
          confirmPasswordPlaceholder: "Répétez le mot de passe",
          submit: "Envoyer la demande",
          submitting: "Envoi de la demande...",
          success: "Inscription réussie. Votre compte est en attente d'approbation. Nous vous informerons par email une fois approuvé.",
          provinces: {
            AB: "Alberta",
        ...
        errors: {
          ...
          pending: "Votre compte grossiste est en attente d'approbation.",
          rejected: "Votre compte grossiste a été refusé. Veuillez contacter le support.",
          sessionExpired: "Votre session détaillant a expiré. Veuillez vous reconnecter.",
          suspended: "Votre compte grossiste est suspendu. Veuillez contacter le support.",
          unauthorized: "Ce compte n'a pas accès au portail détaillant."
        }
      },
      errors: {
