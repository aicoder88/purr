...
export const en = {
  ...
  announcementBar: {
    ...
    naturalCarbon: {
      ...
      line2: 'Fragrance-Free Odor Control',
    },
    socialProof: {
    ...
    moneyBack: {
      ...
      line2: 'Love It or Your Money Back',
    },
  },
  ...
  hero: {
    ...
    subheadline: "Water-filter grade activated carbon traps odor at the source.",
  ...
  features: {
    ...
    catFriendly: {
      ...
      description: "The same filtration-grade approach used in water systems, now tuned for litter box odor."
    },
    longLasting: {
    ...
    anyLitter: {
      ...
      description: "Clay, crystal, clumping, or natural litter. Add on top and keep your routine unchanged."
    },
    costEffective: {
  ...
  howItWorks: {
    ...
    transitionTeaser: "Why cat parents keep using it.",
    nav: {
      carbonVsBakingSoda: "Carbon vs Baking Soda",
      carbonVsBakingSodaDesc: "See the science behind why activated carbon outperforms baking soda for litter box odor control."
    }
  ...
  // Call to Action
  cta: {
    title: "A Fresh-Smelling Home Starts This Week",
    subtitle: "We'll even refund your shipping costs on a free trial if you're not 100% thrilled.",
    ...
    features: [
      {
        ...
        description: "Large internal surface area captures ammonia on contact."
      },
      {
        title: "Fragrance-Free Formula",
        description: "Neutralizes odor without adding perfumes to your home."
      },
      {
        title: "Coconut-Based Carbon",
        description: "Made from natural coconut shell carbon granules."
      }
    ],
    floatingLabel: {
  ...
  agitationSection: {
    badge: "Real-Life Problem",
    headline: "You Know That Moment",
    paragraphs: [
      "You open the door and notice litter box odor right away.",
      "Most cover-ups only add fragrance on top of ammonia.",
  ...
  whyPurrify: {
    ...
    subtitle: "Simple benefits you can see in real life."
  },
  ...
  testimonialLibrary: {
    ...
    retailer: [
      ...
      },
      {
        ...
        businessType: "Gabriel, Manager",
        location: "Kirkland, QC",
        quote: "My clients tell me it gets rid of most, or all of the smell, and the cats don't even notice it!"
      },
      {
  ...
  faqPage: {
    ...
    faqItems: [
      ...
      },
      {
        ...
        answer: "Purrify comes in three sizes: Trial Size 12g provides 1-2 applications for testing, Standard 50g provides approximately 6-8 applications lasting 1-2 months for a single cat household, and Family Pack 120g provides approximately 15-20 applications lasting 3-4 months or suitable for multi-cat households."
      },
      {
  ...
  retailers: {
    ...
    portal: {
      ...
      loginPage: {
        ...
        subtitle: "Access your wholesale account",
        emailLabel: "Email address",
        emailPlaceholder: "your.email@business.com",
        ...
        toggleApply: "Don't have an account? Apply for wholesale access",
        toggleSignIn: "Already have an account? Sign in",
        register: {
          title: "Apply for Wholesale Account",
          subtitle: "Join our network of retail partners",
          businessSectionTitle: "Business Information",
          shippingSectionTitle: "Shipping Address",
          securitySectionTitle: "Account Security",
          businessNameLabel: "Business Name",
          businessNamePlaceholder: "Your Pet Store Inc.",
          ...
          taxIdLabel: "Business Tax ID (Optional)",
          taxIdPlaceholder: "GST/HST Number",
          ...
          postalCodePlaceholder: "M5V 3A8",
          sameAsBilling: "Billing address same as shipping address",
          passwordLabel: "Password",
          passwordPlaceholder: "12+ chars, upper/lowercase, number, special",
          confirmPasswordLabel: "Confirm Password",
          confirmPasswordPlaceholder: "Repeat password",
          submit: "Submit Application",
          submitting: "Submitting application...",
          success: "Registration successful. Your account is pending approval. We will notify you via email once approved.",
          provinces: {
            AB: "Alberta",
            BC: "British Columbia",
            MB: "Manitoba",
        ...
        errors: {
          ...
          pending: "Your wholesale account is pending approval.",
          rejected: "Your wholesale account was rejected. Please contact support.",
          sessionExpired: "Your retailer session expired. Please log in again.",
          suspended: "Your wholesale account is suspended. Please contact support.",
          unauthorized: "This account does not have retailer portal access."
        }
      },
      errors: {
  ...
  thankYou: {
    ...
    referralCta: {
      heading: "Love Purrify?",
      description: "Share with friends and earn $5 credit for each referral!",
  ...
  reviewSystem: {
    customerReviews: "Customer Reviews",
    noReviewsYet: "Be the first to share your experience with Purrify!",
    reviews: "reviews",
    basedOn: "Based on",
    ...
    form: {
      ...
      name: "Your Name",
      email: "Email",
      emailNote: "Not displayed publicly",
      reviewTitle: "Review Title",
      titlePlaceholder: "Summarize your experience",
      reviewContent: "Your Review",
      contentPlaceholder: "What did you like or dislike? How did Purrify work for your cats?",
      productSize: "Size Purchased",
      numberOfCats: "Number of Cats",
      usageDuration: "How Long Used",
      durationPlaceholder: "e.g., 2 weeks",
      submit: "Submit Review",
      cancel: "Cancel",
      thankYou: "Thank you for your review!",
      pendingModeration: "Your review will appear after moderation."
    },
    pagination: {
      previous: "Previous",
      next: "Next"
  ...
  sciencePage: {
    ...
    understanding: {
      sectionTitle: "Understanding Litter Box Odor: The Two Culprits",
      description: "That unmistakable litter box smell comes from two specific molecules. To eliminate them, you need to understand them.",
      ammonia: {
        title: "Ammonia (NH₃)",
        subtitle: "From Cat Urine",
        smell: "Sharp, pungent, eye-watering—like cleaning chemicals",
        moleculeSize: "Tiny at 0.26 nanometers",
        problem: "Forms when bacteria break down urea in urine",
        whyHard: "Most carbon has pores too large to trap such small molecules"
      },
      mercaptans: {
        title: "Mercaptans",
        subtitle: "From Cat Feces",
        smell: "Rotten eggs, sewage, sulfur—that gagging sensation",
        moleculeSize: "Larger, more complex sulfur compounds",
        problem: "Released when proteins in feces decompose",
        whyHard: "Sticky molecules that require specific pore sizes to capture"
      },
      breakthrough: "Here's the breakthrough: Most activated carbon is designed for water filtration or general air purification. We worked with research scientists to engineer carbon specifically for these two molecules—creating the perfect trap for cat litter odor."
    },
    imageCaptions: {
      freshHome: {
        title: "Your Cat Deserves a Fresh Home",
        description: "Molecular-level odor elimination, not masking"
      },
      noOdors: {
        title: "No More Embarrassing Odors",
        description: "Science-backed odor control for modern cat owners"
      }
    },
    poreSize: {
      sectionTitle: "The Perfect Pore Size Distribution",
      description: "Laboratory testing confirms our optimized micropore-mesopore-macropore ratio",
      micropores: {
        size: "<2nm",
        title: "Micropores",
        specialist: "Ammonia Specialists",
        target: "NH₃ (0.26nm)",
      ...
      macropores: {
        size: ">50nm",
        title: "Macropores",
        specialist: "Transport System",
        target: "All molecules",
        density: "Strategic placement",
        function: "Rapid delivery to capture sites"
      },
      surfaceArea: {
        title: "Surface Area: 1050 m²/g",
        description: "That's over 12 tennis courts of odor-capturing surface area in just one gram of Purrify™",
        iodineNumber: "Iodine Number mg/g",
        ctcAdsorption: "CTC Adsorption",
        hardness: "Hardness",
        moisture: "Moisture"
      }
    },
    scienceFacts: {
      sectionTitle: "Precision-Engineered Pore Structure",
      description: "Not all activated carbon is created equal. We worked with scientists to optimize every detail for cat litter odor.",
      facts: [
        {
    ...
    microscopicView: {
      imageCaptions: {
        microscope: "Research-grade microscopy reveals pore structure",
        labTesting: "Laboratory testing confirms optimized performance",
        molecular: "Molecular-level capture of odor compounds"
      },
      whatYoureLookingAt: {
      ...
      quote: {
        text: "The key is not just having pores, but having the right sized pores in the right ratios for the specific molecules you want to capture.",
        attribution: "Research collaboration with activated carbon scientists"
      }
    },
    technicalPerformance: {
      sectionTitle: "Laboratory-Verified Performance",
      description: "Real data from activated carbon testing confirms our optimized pore structure delivers superior adsorption",
      particleSize: {
        title: "8×30 Mesh Particle Distribution",
        effectiveSize: "Effective Size:",
        meanDiameter: "Mean Diameter:",
        uniformityCoefficient: "Uniformity Coefficient:",
        whyMatters: "Why this matters: Consistent particle sizing ensures uniform flow through litter and maximum contact with odor molecules. Our 8×30 mesh is specifically sized for optimal cat litter performance."
      },
      adsorption: {
        title: "Rapid Dechlorination Performance",
        halfLength: "Half-Length Value:",
        apparentDensity: "Apparent Density:",
        betSurface: "BET Surface Area:",
        whyMatters: "Why this matters: Rapid chlorine removal proves the carbon's micro porous structure is highly active. If it can capture chlorine molecules this quickly, ammonia doesn't stand a chance."
      }
    },
    engineeredPerformance: {
      ...
      stats: {
        ...
        pressureLossLabel: "Pressure Loss"
      }
    },
    processTimeline: {
      sectionTitle: "How the Three Pore Types Work Together",
      description: "Our research-backed pore architecture creates a capture system specifically engineered for cat litter odors.",
      steps: [
        {
    ...
    researchSection: {
      ...
      stats: {
        ...
        poreTypes: "3 Pore Types",
        poreTypesLabel: "Micro + Meso + Macro = Complete Capture",
        surfaceArea: "1050 m²/g",
        surfaceAreaLabel: "Surface Area - Millions of Capture Sites"
      },
      buttons: {
        experience: "Experience the Science",
        learnMore: "Learn More"
      }
    },
