export const INTERNAL_LINK_OPTIONS = [
  ...
  { label: 'Step-by-Step: How to Use Cat Litter Deodorizer', url: '/blog/how-to-use-cat-litter-deodorizer' },
  { label: 'Are Litter Deodorizers Safe for Kittens?', url: '/blog/using-deodorizers-with-kittens' },
  { label: 'Complete Cat Litter Guide', url: '/learn/cat-litter-guide' },
  { label: 'Activated Carbon vs Baking Soda', url: '/blog/activated-carbon-vs-baking-soda-comparison' },
  { label: 'Benefits of Activated Carbon for Cat Owners', url: '/blog/activated-carbon-litter-additive-benefits' },
  { label: 'Frequently Asked Questions', url: '/learn/faq' },
  { label: 'Safety Information', url: '/learn/safety' },
  // Solutions (now at blog)
  { label: 'Fix Ammonia Smell in Cat Litter', url: '/blog/how-to-neutralize-ammonia-cat-litter' },
  { label: 'Apartment Cat Odor Solutions', url: '/blog/best-litter-odor-remover-small-apartments' },
  { label: 'Multiple Cats Odor Control', url: '/blog/best-cat-litter-multiple-cats-odor-control' },
  { label: 'Natural Cat Litter Additive Guide', url: '/blog/best-natural-cat-litter-odor-control' },
  // Blog posts
