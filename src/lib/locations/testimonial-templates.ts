...
export const quoteTemplates: QuoteTemplate[] = [
  ...
  (_context, persona) => `After three months of testing various odor control products for ${persona.household}, I can confirm this is the only one that eliminated ammonia smell rather than masking it. Highly effective.`,
  ...
  (_context, persona) => `Been a ${persona.occupation} for 15 years and never thought I'd be writing about cat litter additives, but here we are. This product saved my home office situation. The smell was genuinely affecting my ability to concentrate.`,
  ...
  (_context, persona) => `As someone with ${persona.household}, I've become an unwilling expert on odor control. This is the first product I've used that I'd actually recommend to other multi-cat households without reservation.`,
  ...
  (_context, persona) => `Running ${persona.household} through a small space, I needed something industrial-strength. This handles it without making my place smell like a Bath & Body Works exploded.`,
