...
export const SecurityBadges: React.FC<{ className?: string }> = ({
  className = "",
}) => <TrustBadges variant="compact" maxBadges={3} className={className} />;

export const CheckoutTrustBadges: React.FC<{ className?: string }> = ({
  className = "",
}) => {
...
export const SocialProofBadges: React.FC<{ className?: string }> = ({
  className = "",
}) => {
  ...
  return (
    <div className={`grid grid-cols-1 md:grid-cols-3 gap-4 ${className}`}>
      {socialBadges.map((badge) => (
        <div
          key={badge.id}
          className="text-center p-4 bg-white dark:bg-gray-800 rounded-lg shadow-md border border-gray-200 dark:border-gray-700"
        >
