      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <motion.div
            ...
            className="bg-white dark:bg-gray-800/50 p-4 rounded-xl shadow-sm border border-[#E0EFC7]/50 flex flex-col justify-between"
          >
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            ...
            <div className="bg-white dark:bg-gray-800/70 p-4 rounded-lg shadow-sm border border-[#E0EFC7]/50 text-center">
              ...
              <div className="flex items-center justify-center mb-2">
                <motion.div
                  className="w-20 h-20 rounded-full bg-gradient-to-r from-[#FF3131] to-[#FF3131]/80 flex items-center justify-center text-white dark:text-gray-100 text-xl font-bold"
                  initial={{ scale: 0 }}
                  animate={{ scale: 1 }}
                  transition={{
                    type: "spring",
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            <div className="bg-white dark:bg-gray-800/70 p-4 rounded-lg shadow-sm border border-[#E0EFC7]/50">
              ...
              <div className="grid grid-cols-2 gap-3">
                {yearlyImpactMetrics.map((metric, index) => (
                  <motion.div
                    key={metric.title}
                    className="bg-white dark:bg-gray-800/80 p-3 rounded-lg flex flex-col items-center text-center"
                    initial={{ opacity: 0, y: 10 }}
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ duration: 0.3, delay: 0.1 * index }}
                  >
                    <div className="mb-1">{metric.icon}</div>
                    <h6 className="text-xs font-medium text-gray-700 dark:text-gray-200">
                      {metric.title}
                    </h6>
          ...
          >
            <div className="bg-white dark:bg-gray-800/80 rounded-full p-3 shadow-md">
        ...
        >
          <Button className="w-full bg-gradient-to-r from-[#03E46A] to-[#5B2EFF] hover:from-[#03E46A]/90 hover:to-[#5B2EFF]/90 text-white dark:text-gray-100 font-bold py-4 px-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 border-0 text-lg">
            START SAVING NOW
          </Button>
        </motion.div>
      </div>
