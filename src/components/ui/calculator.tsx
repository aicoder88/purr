  ...
  return [
    {
      ...
      unit: "kg",
      icon: <Leaf className="h-5 w-5 text-green-500 text-green-400" />,
    ...
    },
    {
      ...
      unit: "",
      icon: <TreePine className="h-5 w-5 text-emerald-600 text-emerald-400" />,
    ...
    },
    {
      ...
      unit: "",
      icon: <Car className="h-5 w-5 text-blue-500 text-blue-400" />,
    ...
    },
    {
      ...
      unit: "",
      icon: <Cat className="h-5 w-5 text-purple-500 text-purple-400" />,
...
export function CostCalculator({ className }: CostCalculatorProps) {
  ...
  return (
    <div
      className={`bg-[#FFFFFF]/95 bg-gray-900/90 backdrop-blur-md rounded-2xl p-8 shadow-xl border border-[#E0EFC7] border-gray-800 ${className}`}
    >
      <motion.h3
        className="text-3xl font-bold mb-6 text-center bg-gradient-to-r from-[#5B2EFF] to-[#03E46A] from-[#3694FF] to-[#FF5050] bg-clip-text text-transparent"
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <motion.div
            ...
            className="bg-white bg-gray-800/50 p-4 rounded-xl shadow-sm border border-[#E0EFC7]/50 flex flex-col justify-between"
          >
            <div className="flex justify-center mb-2">
              <Cat className="h-5 w-5 text-[#5B2EFF]" />
            </div>
            <label className="block text-sm font-medium text-gray-700 text-gray-200 text-center">
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            {/* Annual Savings */}
            <div className="bg-white bg-gray-800/70 p-4 rounded-lg shadow-sm border border-[#E0EFC7]/50 text-center">
              <p className="text-sm font-medium text-gray-600 text-gray-300 mb-2">
                Annual Savings
              </p>
              <div className="flex items-center justify-center mb-2">
                <motion.div
                  className="w-20 h-20 rounded-full bg-gradient-to-r from-[#5B2EFF] to-[#03E46A] flex items-center justify-center text-white text-gray-100 text-xl font-bold"
                  initial={{ scale: 0 }}
                  animate={{ scale: 1 }}
                  transition={{
                    type: "spring",
            ...
            <div className="bg-white bg-gray-800/70 p-4 rounded-lg shadow-sm border border-[#E0EFC7]/50 text-center">
              ...
              <div className="flex items-center justify-center mb-2">
                <motion.div
                  className="w-20 h-20 rounded-full bg-gradient-to-r from-[#FF3131] to-[#FF3131]/80 flex items-center justify-center text-white text-gray-100 text-xl font-bold"
                  initial={{ scale: 0 }}
                  animate={{ scale: 1 }}
                  transition={{
                    type: "spring",
          ...
          {/* Savings Graph */}
          <div className="mt-6">
            <p className="text-sm font-medium text-gray-700 text-gray-200 mb-3 text-center">
              10-Year Savings Projection
            </p>
            <div className="bg-white bg-gray-800/70 rounded-lg p-4 border border-[#E0EFC7] border-gray-700">
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            <div className="bg-white bg-gray-800/70 p-4 rounded-lg shadow-sm border border-[#E0EFC7]/50">
              ...
              <div className="grid grid-cols-2 gap-3">
                {yearlyImpactMetrics.map((metric, index) => (
                  <motion.div
                    key={metric.title}
                    className="bg-white bg-gray-800/80 p-3 rounded-lg flex flex-col items-center text-center"
                    initial={{ opacity: 0, y: 10 }}
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ duration: 0.3, delay: 0.1 * index }}
                  >
                    <div className="mb-1">{metric.icon}</div>
                    <h6 className="text-xs font-medium text-gray-700 text-gray-200">
                      {metric.title}
                    </h6>
                    ...
                    <div className="w-full h-1 bg-gray-100 bg-gray-700 rounded-full mt-1 overflow-hidden">
                      <motion.div
          ...
          >
            <div className="bg-white bg-gray-800/80 rounded-full p-3 shadow-md">
        ...
        >
          <Button className="w-full bg-gradient-to-r from-[#03E46A] to-[#5B2EFF] hover:from-[#03E46A]/90 hover:to-[#5B2EFF]/90 text-white text-gray-100 font-bold py-4 px-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 border-0 text-lg">
            START SAVING NOW
          </Button>
        </motion.div>
      </div>
