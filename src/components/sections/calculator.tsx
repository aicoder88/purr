...
function CalculatorLoading() {
  ...
  return (
    <div className="w-full h-96 flex items-center justify-center bg-white/50 bg-gray-800/50 rounded-2xl border border-gray-200 border-gray-700">
...
export function Calculator() {
  ...
  return (
    <section
      className="py-12 bg-gradient-to-b from-white to-orange-50 from-gray-900 to-gray-950 transition-colors duration-300"
      id="calculator"
    >
      <Container>
        <div className="max-w-3xl mx-auto text-center mb-12">
          <h2 className="font-heading text-5xl font-bold tracking-tight mb-4 bg-gradient-to-r from-[#03E46A] to-[#5B2EFF] from-[#3694FF] to-[#FF5050] bg-clip-text text-transparent">
