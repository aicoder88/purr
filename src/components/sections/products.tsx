...
const SectionHeader = dynamic(() => import("../ui/section-header"), {
  ssr: true,
});
    ...
    >
      <Container>
        <div className="max-w-3xl mx-auto text-center mb-12">
          <SectionHeader
            text={
              t.productsSection?.forEveryCatHousehold ||
          ...
          <h2 className="text-5xl font-bold tracking-tight mb-6 bg-gradient-to-r from-[#FF3131] to-[#FF3131]/80 dark:from-[#FF5050] dark:to-[#FF5050]/80 bg-clip-text text-transparent">
            {t.productsSection?.pickYourPowerLevel ||
        ...
        <div className="relative max-w-4xl mx-auto mb-12 px-4">
          ...
          <div className="flex justify-between mt-2">
            ...
            <span className="text-sm font-medium text-gray-600 dark:text-gray-300">
              {t.productsSection?.powerLevels?.standardPower ||
                "Standard Power"}
            </span>
            <span className="text-sm font-medium text-gray-600 dark:text-gray-300">
        ...
        <div
          className={`grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto transition-all duration-1000 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}
        >
                    ...
                    {(
                      ...
                      .map((line, i) => (
                        <div key={i} className="flex items-start">
                          {i > 0 && (
                            <div className="text-[#FF3131] mr-2 mt-1">•</div>
                          )}
                          <p
                            className={`text-gray-700 dark:text-gray-300 ${i === 0 ? "font-medium text-lg" : ""}`}
                          >
                            {line}
                          </p>
                        </div>
        ...
        <div className="mt-16">
          <ReviewSystem compact={true} maxReviews={3} showFilters={false} />
        </div>
      </Container>
    </section>
  );
