        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Join thousands of happy cat parents who never worry about odors
              again. Get Purrify delivered automatically and save money every
              month.
            </p>
          </div>
                  ...
                  <div className="text-center mb-6">
                    ...
                    <div className="mb-4">
                      <div className="flex items-center justify-center mb-2">
                        <span className="text-4xl font-bold text-[#FF3131]">
                          ${plan.price}
                        </span>
          ...
          <div className="mt-12 text-center">
            ...
            <p className="text-sm text-gray-500 italic">
              "I've saved over $200 this year with my subscription, and my cats'
              litter box never smells!" - Sarah M.
            </p>
          </div>
        </div>
      </Container>
