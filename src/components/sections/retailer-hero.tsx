          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-center lg:text-left">
              ...
              <div className="grid grid-cols-3 gap-4 mb-8">
                <div className="text-center p-4 bg-white dark:bg-gray-800/50 rounded-xl backdrop-blur-sm">
                  <div className="text-3xl font-black text-[#5B2EFF] dark:text-[#3694FF]">
                    {hero?.stats?.profitMargins?.value || '50%'}
                  </div>
                  <div className="text-sm font-semibold text-gray-600 dark:text-gray-300">
                    {hero?.stats?.profitMargins?.label || 'Profit Margins'}
                  </div>
                </div>
                <div className="text-center p-4 bg-white dark:bg-gray-800/50 rounded-xl backdrop-blur-sm">
                  <div className="text-3xl font-black text-[#FF3131] dark:text-[#FF5050]">
                    {hero?.stats?.repurchaseRate?.value || '89%'}
                  </div>
                  <div className="text-sm font-semibold text-gray-600 dark:text-gray-300">
                    {hero?.stats?.repurchaseRate?.label || 'Repurchase Rate'}
                  </div>
                </div>
                <div className="text-center p-4 bg-white dark:bg-gray-800/50 rounded-xl backdrop-blur-sm">
                  <div className="text-3xl font-black text-[#5B2EFF] dark:text-[#3694FF]">
                  ...
                  <div className="text-sm font-semibold text-gray-600 dark:text-gray-300">
                    {hero?.stats?.setupTime?.label || 'Setup Time'}
                  </div>
                </div>
              </div>
              ...
              <div className="mt-8 text-center lg:text-left">
                ...
                <div className="flex flex-wrap justify-center lg:justify-start gap-4 items-center">
                  <span className="px-3 py-1 bg-gray-100 dark:bg-gray-800 rounded-lg text-xs font-semibold text-gray-600 dark:text-gray-300">
                    {hero?.trustIndicators?.types?.petStores || 'Pet Stores'}
                  </span>
                  <span className="px-3 py-1 bg-gray-100 dark:bg-gray-800 rounded-lg text-xs font-semibold text-gray-600 dark:text-gray-300">
                    {hero?.trustIndicators?.types?.vetClinics || 'Vet Clinics'}
                  </span>
                  <span className="px-3 py-1 bg-gray-100 dark:bg-gray-800 rounded-lg text-xs font-semibold text-gray-600 dark:text-gray-300">
                    {hero?.trustIndicators?.types?.groomers || 'Groomers'}
                  </span>
                  <span className="px-3 py-1 bg-gray-100 dark:bg-gray-800 rounded-lg text-xs font-semibold text-gray-600 dark:text-gray-300">
                    {hero?.trustIndicators?.types?.distributors || 'Distributors'}
                  </span>
                </div>
              </div>
            </div>
              ...
              <div className="bg-white dark:bg-gray-800/70 backdrop-blur-sm rounded-2xl p-6 shadow-xl border border-gray-200/50 dark:border-gray-700/50 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
                <div className="flex items-center mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-[#5B2EFF] dark:text-[#3694FF] font-bold">
              ...
              <div className="bg-white dark:bg-gray-800/70 backdrop-blur-sm rounded-2xl p-6 shadow-xl border border-gray-200/50 dark:border-gray-700/50 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
                <div className="flex items-center mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-[#FF3131] dark:text-[#FF5050] font-bold">
