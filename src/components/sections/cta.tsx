  ...
  return (
    <section className="py-12 relative overflow-hidden bg-gradient-to-r from-[#5B2EFF] to-[#03E46A] dark:from-[#3694FF] dark:to-[#FF5050] opacity-90 transition-colors duration-300">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden">
        <div className="absolute top-10 left-10 w-40 h-40 bg-white dark:bg-gray-800 rounded-full opacity-10"></div>
        <div className="absolute bottom-10 right-10 w-60 h-60 bg-white dark:bg-gray-800 rounded-full opacity-10"></div>
        <div className="absolute top-1/2 left-1/4 w-20 h-20 bg-white dark:bg-gray-800 rounded-full opacity-10 animate-pulse"></div>
        <div
          className="absolute bottom-1/3 right-1/3 w-32 h-32 bg-white dark:bg-gray-800 rounded-full opacity-10 animate-pulse"
      ...
      <Container className="relative z-10">
        <div className="flex flex-col md:flex-row items-center justify-between gap-12 backdrop-blur-sm bg-white dark:bg-gray-800/10 dark:bg-black/30 rounded-3xl p-10 border border-white/20 dark:border-[#3694FF]/30 shadow-2xl relative overflow-hidden">
          ...
          <div className="flex flex-col gap-4 min-w-[200px]">
            <Button
              size="lg"
              className="bg-white dark:bg-gray-800 text-[#5B2EFF] hover:bg-gray-100 dark:bg-[#3694FF] dark:text-white dark:text-gray-100 font-bold py-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 text-lg"
            >
