  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-orange-50 to-pink-50 from-gray-900 to-gray-800">
          ...
          <div className="max-w-6xl mx-auto text-center">
            <nav className="mb-6 text-sm">
              <Link
                href="/locations"
                prefetch={false}
                className="text-orange-600 text-orange-400 hover:underline"
              >
                {locale === 'fr' ? 'Emplacements' : 'Locations'}
              </Link>
              <span className="mx-2 text-gray-500 text-gray-400">/</span>
              <span className="text-gray-700 text-gray-300">{provinceName}</span>
            </nav>
            ...
            <p className="text-xl md:text-2xl text-gray-700 text-gray-200 mb-8 max-w-3xl mx-auto">
              {description}
            </p>
            ...
            <div className="bg-white bg-gray-800/90 rounded-lg p-6 shadow-lg max-w-3xl mx-auto">
              <div className="grid md:grid-cols-3 gap-6 text-center">
                <div>
                  <div className="text-3xl font-bold text-orange-600 text-orange-400 mb-2">
                    {cityCount}+
                  </div>
              ...
              <div className="mt-6 flex flex-col sm:flex-row items-center justify-center gap-4">
                <Link
                  ...
                  prefetch={false}
                  className="inline-flex items-center justify-center bg-gradient-to-r from-orange-500 to-pink-500 text-white text-gray-100 font-bold py-3 px-6 rounded-lg hover:from-orange-600 hover:to-pink-600 transition-all"
                >
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                {majorCities.map((city) => (
                  <Link
                    ...
                    prefetch={false}
                    className="bg-gradient-to-br from-gray-50 to-white from-gray-700/70 to-gray-700/50 p-6 rounded-xl border border-gray-200 border-gray-600 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1"
                  >
                    <h3 className="font-heading text-xl font-bold text-gray-900 text-gray-50 mb-2">
                      {city.name}
                    </h3>
                    <p className="text-gray-600 text-gray-300 text-sm mb-3">
                    ...
                    <div className="flex flex-wrap gap-2 mb-3">
                      {city.housingHighlights.slice(0, 2).map((highlight, idx) => (
                        <span
                          key={idx}
                          className="text-xs px-2 py-1 bg-orange-100 bg-orange-900/30 text-orange-700 text-orange-300 rounded-full"
                        >
                          {highlight}
                        </span>
                      ))}
                    </div>
                    <span className="text-orange-600 text-orange-400 font-semibold text-sm">
            ...
            <div className="grid md:grid-cols-3 lg:grid-cols-4 gap-4">
              {cities.map((city) => (
                <Link
                  ...
                  href={`/locations/${city.slug}`}
                  prefetch={false}
                  className="bg-white bg-gray-800 p-4 rounded-lg border border-gray-200 border-gray-700 hover:border-orange-500 hover:border-orange-400 hover:shadow-md transition-all"
                >
                  <div className="font-semibold text-gray-900 text-gray-50">
                    {city.name}
                  </div>
        ...
        <section className="py-16 px-4 bg-white bg-gray-800">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-gradient-to-br from-orange-50 to-pink-50 from-orange-900/20 to-pink-900/20 p-6 rounded-xl border border-orange-200 border-orange-700">
                <h3 className="font-heading text-xl font-bold mb-3 text-gray-900 text-gray-50">
              ...
              <div className="bg-gradient-to-br from-blue-50 to-purple-50 from-blue-900/20 to-purple-900/20 p-6 rounded-xl border border-blue-200 border-blue-700">
                <h3 className="font-heading text-xl font-bold mb-3 text-gray-900 text-gray-50">
              ...
              <div className="bg-gradient-to-br from-green-50 to-teal-50 from-green-900/20 to-teal-900/20 p-6 rounded-xl border border-green-200 border-green-700">
                <h3 className="font-heading text-xl font-bold mb-3 text-gray-900 text-gray-50">
              ...
              <div className="bg-gradient-to-br from-purple-50 to-pink-50 from-purple-900/20 to-pink-900/20 p-6 rounded-xl border border-purple-200 border-purple-700">
                <h3 className="font-heading text-xl font-bold mb-3 text-gray-900 text-gray-50">
        ...
        {/* CTA Section */}
        <section className="py-16 px-4 bg-gradient-to-br from-orange-100 to-pink-100 from-orange-900/30 to-pink-900/30">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href="/products/trial-size"
                prefetch={false}
                className="inline-flex items-center justify-center bg-gradient-to-r from-orange-500 to-pink-500 text-white text-gray-100 font-bold py-4 px-8 rounded-lg hover:from-orange-600 hover:to-pink-600 transition-all shadow-lg hover:shadow-xl text-lg"
              >
              ...
              <Link
                href="/learn/faq"
                prefetch={false}
                className="inline-flex items-center justify-center bg-white bg-gray-700 text-gray-900 text-white font-semibold py-4 px-8 rounded-lg hover:bg-gray-50 hover:bg-gray-600 transition-all border border-gray-300 border-gray-600 text-lg"
              >
