...
export function SolutionSection({
  ...
  return (
    <section
      id={id}
      className="bg-blue-50 dark:bg-gray-800 py-16 lg:py-24 scroll-mt-20"
    >
      <Container>
        ...
        <div className="max-w-4xl mx-auto">
          {/* Diagram */}
          <div className="relative aspect-[16/9] rounded-xl overflow-hidden bg-white dark:bg-gray-700 shadow-lg mb-8">
            <Image
              src={diagramSrc}
              alt={diagramAlt}
              fill
