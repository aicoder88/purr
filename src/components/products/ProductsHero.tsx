  ...
  const locale = useLocale();
    ...
    const trustBadge = (
        <motion.div
            ...
            className="mt-8 flex items-center gap-3 text-sm font-medium text-gray-500 text-gray-400"
        >
    ...
    return (
        <section
            ref={containerRef}
            className="relative overflow-hidden bg-[#FFFFF5] bg-gray-900 pt-16 pb-20 lg:pt-32 lg:pb-32"
        >
            {/* Background Decor */}
            <div className="absolute top-0 right-0 w-1/2 h-full bg-gradient-to-l from-brand-purple/5 to-transparent from-brand-purple/10 pointer-events-none" />
            <div className="absolute -top-24 -right-24 w-96 h-96 bg-brand-red/5 rounded-full blur-3xl pointer-events-none" />
            <div className="absolute top-1/2 left-0 w-64 h-64 bg-blue-400/5 bg-blue-500/10 rounded-full blur-3xl pointer-events-none" />
                ...
                <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
                    ...
                    <div className="order-2 lg:order-1 flex flex-col items-start text-left">
                        ...
                        <motion.div
                            ...
                            className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-brand-purple/10 text-brand-purple text-purple-300 font-medium text-sm mb-6"
                        >
                            <span className="relative flex h-2 w-2">
                                <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-purple-400 bg-purple-500 opacity-75"></span>
                        ...
                        <motion.h1
                            ...
                            className="font-heading text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 text-gray-50 leading-[1.1] tracking-tight mb-6"
                        >
                        ...
                        <motion.p
                            ...
                            className="text-lg md:text-xl text-gray-600 text-gray-300 leading-relaxed max-w-xl mb-8"
                        >
                            {useEnglishVariantHeadline
                        ...
                        >
                            <Button
                                asChild
                                size="lg"
                                className="bg-brand-purple hover:bg-brand-purple/90 text-white text-gray-100 font-bold text-lg px-8 py-6 h-auto shadow-xl shadow-brand-purple/20 transition-all hover:scale-105"
                            >
                            ...
                            <Button
                                ...
                                variant="ghost"
                                size="lg"
                                className="text-gray-600 text-gray-300 hover:text-brand-purple hover:text-purple-400 hover:bg-transparent font-medium group"
                            >
                    ...
                    <div className="order-1 lg:order-2 relative h-[400px] lg:h-[600px] w-full flex items-center justify-center">
                        ...
                        <motion.div
                            style={{ y: y }}
                            className="absolute inset-0 bg-gradient-to-b from-brand-light to-transparent from-brand-purple/20 rounded-full blur-3xl opacity-60 scale-90"
                        />
                        ...
                        <div className="relative w-full h-full max-w-[600px] mx-auto perspective-1000">
                            ...
                            >
                                ...
                                {/* Decoration/Context */}
                                <div className="absolute top-1/4 left-0 bg-white/80 bg-gray-800/80 backdrop-blur-md p-3 rounded-xl shadow-lg border border-brand-purple/10 z-40 animate-float">
                                    <div className="flex items-center gap-2">
                                        <CheckCircle2 className="w-5 h-5 text-green-500 text-green-400" />
                                        <span className="text-sm font-bold text-gray-800 text-gray-200">
            ...
            <div className="absolute bottom-0 left-0 w-full overflow-hidden leading-none z-10">
                <svg
                    className="relative block w-[calc(100%+1.3px)] h-[60px] text-white text-gray-800"
                    data-name="Layer 1"
                ...
                >
                    <path
                        ...
                        className="fill-[#FFFFF5] fill-gray-900"
           ...
           */}
                    <path
                        ...
                        className="fill-white fill-gray-800"
                    ></path>
                </svg>
            </div>
