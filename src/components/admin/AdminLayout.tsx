          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-4">
              <Link href="/admin/blog" className="flex items-center space-x-2">
                ...
                <span className="text-xl font-semibold text-gray-900 text-gray-50">Blog Admin</span>
              </Link>
            </div>
            ...
            <div className="flex items-center space-x-4">
              <Link
                href="/"
                target="_blank"
                className="text-sm text-gray-600 text-gray-300 hover:text-gray-900 hover:text-gray-100"
              >
                View Site
              </Link>
              <div className="flex items-center space-x-2 px-3 py-2 rounded-lg bg-gray-100 bg-gray-700">
                ...
                <span className="text-xs text-gray-500 text-gray-400 ml-2 px-2 py-0.5 bg-purple-100 bg-purple-900/20 text-purple-700 text-purple-300 rounded">
                  {userRole}
                </span>
              </div>
              <button
