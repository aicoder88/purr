...
const statusConfig: Record<LeadStatus, { label: string; className: string }> = {
  ...
  CONTACTED: {
    label: 'Contacted',
    className: 'bg-purple-100 text-purple-700 bg-purple-900/30 text-purple-300'
  },
  SAMPLE_SENT: {
    label: 'Sample Sent',
  ...
  FOLLOWING_UP: {
    label: 'Following Up',
    className: 'bg-yellow-100 text-yellow-700 bg-yellow-900/30 text-yellow-300'
  },
  CONVERTED: {
    label: 'Converted',
  ...
  NOT_INTERESTED: {
    ...
    className: 'bg-gray-100 text-gray-700 bg-gray-700 text-gray-300'
  },
  NO_RESPONSE: {
    label: 'No Response',
