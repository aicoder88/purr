...
export function EnhancedStructuredData({
    ...
    review: [
      {
        ...
        reviewBody:
          "Amazing product! Completely eliminated the cat litter odor in our home.",
  ...
  const videoSchema = {
    ...
    description:
      "Watch how Purrify eliminates cat litter odors at the molecular level using activated carbon technology.",
    ...
    genre: "Educational",
    keywords:
      "cat litter, odor control, activated carbon, pet care, odor elimination",
  };
